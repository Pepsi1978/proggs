...
**Stand:** 2026-06-13 (macOS-Session: Versions-Drift behoben, v2.1.177 lokal verifiziert)

- **Plattform:** Windows 11 Home 10.0.26200 (x64), Claude Code **v2.1.177** (Drift behoben: stand auf v2.1.165), Opus 4.8 (1M context, neuer Default seit Mai — High Effort by Default, Lean System Prompt, Dynamic Workflows Research Preview)
...
- **Sicherheit:** Claude Code v2.1.177 (alle bekannten CVEs gepatcht). NEU offen: Axios npm Supply-Chain (NK-Attribution, April 2026) — npm audit in PromptBoard + VoiceOverlay-Projekten DRINGEND. Comment-and-Control Prompt Injection 2.0 (Mai 2026, Microsoft Research) — Parry-Scanner aktiv halten.
