...
# 1. Modell (erstes Element — KEIN fuehrender Trenner. Frank 2026-05-25: ganz nach vorne)
...
# 7. Context-Verbrauch (hinter den Limit-Bereichen, vor dem Ordner — Frank 2026-05-25)
if [ -n "$ctx_used" ]; then
