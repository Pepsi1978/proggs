#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""bug-almanac-hint.py — UserPromptSubmit-Logik des semantischen Almanach-Triggers (Welle 3, 2026-07-18).
...
AREAS = {
    ...
    "opencode/opencode-cli":        ("OpenCode CLI",          ["opencode maus", "opencode-maus", "opencode copy", "opencode-copy", "opencode paste", "opencode-paste", "opencode zwischenablage", "opencode-zwischenablage", "opencode rechtsklick", "opencode-rechtsklick", "opencode tui", "opencode-tui", "opencode priority", "opencode-priority", "opencode fast", "opencode-fast", "opencode oauth", "opencode-oauth", "servicetier", "service_tier", "tui.json", "copy on select", "copy-on-select"]),
