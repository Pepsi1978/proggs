...
Frank arbeitet oft mit **4-5 gleichzeitig offenen Claude-Code-Sessions** am selben
...
| CLAUDE.md "Commit + Push nach JEDER Aenderung" | Diese Regel verschaerft die Reihenfolge: Commit+Push kommt VOR Build, nicht erst danach |
...
Diese Datei (`~/.claude/rules/commit-before-build.md`) wird automatisch in jeder
