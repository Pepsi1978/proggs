...
> Der Benutzer arbeitet oft mit 4–5 gleichzeitig offenen Claude-Code-Sessions am
...
**Pflicht für Claude Code:** Beim Session-Start prüfen ob diese Werte gesetzt sind.
...
Wenn Claude Code unklar ist ob eine andere Session gerade denselben Code
...
| CLAUDE.md "Commit + Push nach JEDER Änderung" | Wird von dieser Regel ergänzt um das WIE bei parallelen Sessions |
