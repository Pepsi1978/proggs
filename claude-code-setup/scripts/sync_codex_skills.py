...
REPLACEMENTS = (
    ("/Users/frank/.claude/", "~/.codex/"),
    ("/Users/barwa/.claude/", "~/.codex/"),
    ("/Users/frank/.codex/", "~/.codex/"),
    ("/Users/barwa/.codex/", "~/.codex/"),
    ("$env:USERPROFILE/.claude/", "$env:USERPROFILE/.codex/"),
    ("%USERPROFILE%/.claude/", "%USERPROFILE%/.codex/"),
    ("$env:USERPROFILE\\.claude\\", "$env:USERPROFILE\\.codex\\"),
    ("%USERPROFILE%\\.claude\\", "%USERPROFILE%\\.codex\\"),
    ("~/.claude/", "~/.codex/"),
    (".claude/agent-memory/shared/", ".codex/agent-memory/shared/"),
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Synchronisiert Skills aus claude-code-setup nach ~/.codex/skills "
            "und passt .claude-/proggs-Verweise an Codex an."
        )
    )
    parser.add_argument(
        "--source-root",
        ...
        help="Pfad zum claude-code-setup-Verzeichnis.",
    )
    parser.add_argument(
        "--target-root",
        type=Path,
