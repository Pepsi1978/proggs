...
- Default: `effortLevel: high` (permanenter Standard laut CLAUDE.md). Protected: `model: opus[1m]`, `SUBAGENT_MODEL: opus[1m]` (hoechstes Modell + 1M Kontext, Policy 2026-06-01)
