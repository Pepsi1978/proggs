...
search_fixed "Session-Start-Sync" "codex-setup/README.md"
search_fixed "session-start-sync.mjs" "codex-setup/README.md"
search_fixed "session-start-sync.sh" "codex-setup/README.md"
search_fixed "session-start-sync.ps1" "codex-setup/README.md"
search_fixed "MCP-Konfig-Restore" "codex-setup/README.md"
search_fixed "restore-mcp-config.mjs" "codex-setup/README.md"
...
search_fixed "git pull --rebase --autostash origin main" "codex-setup/rules/global.md"
...
search_fixed "session-start-sync" "codex-setup/skills/self-improve/SKILL.md"
search_fixed "codex-setup/mcp-windows.json" "codex-setup/skills/self-improve/SKILL.md"
search_fixed "git diff --stat HEAD..origin/main" "codex-setup/skills/self-improve/SKILL.md"
search_fixed "git pull --rebase --autostash origin main" "codex-setup/skills/self-improve/SKILL.md"
