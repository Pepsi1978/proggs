...
SETUP_DIR="$HOME/proggs/codex-harness"
REF_FILE="$SETUP_DIR/hooks-macos.json"
COMMENT="Complete hooks reference for macOS. Merge into ~/.codex/settings.json on macOS. Uses bash for command hooks. Prompt-injection-defender requires Python 3 (python3). Parry requires ~/.cargo/bin/parry. Bun at /opt/homebrew/bin/bun. AUTO-GENERATED by sync-hooks-reference.sh — do not edit manually."
