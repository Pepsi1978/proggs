...
#
# ANWENDUNG:
#   bash ~/.codex/hooks/path-verify.sh          # Pruefung
#   bash ~/.codex/hooks/path-verify.sh --fix    # Pruefung + Reparatur
...
# --- Codex CLI ---
check_cmd "codex" "Codex CLI" "npm install -g @anthropic-ai/codex"

# --- codexwatch ---
check_cmd "codexwatch" "codexwatch" "gh release download --repo blackwell-systems/codexwatch"
