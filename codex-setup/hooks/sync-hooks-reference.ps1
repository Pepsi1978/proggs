...
# Adapted from MIRROR-2026-03-25-MAC-008 by import agent on 2026-03-26

$ErrorActionPreference = "SilentlyContinue"

$Settings = Join-Path $env:USERPROFILE ".codex\settings.json"
$SetupDir = Join-Path $env:USERPROFILE "proggs\codex-harness"
$RefFile = Join-Path $SetupDir "hooks-windows.json"
$Comment = "Complete hooks reference for Windows. Merge into ~/.codex/settings.json on Windows. Uses pwsh (PowerShell 7). AUTO-GENERATED by sync-hooks-reference.ps1 -- do not edit manually."
