...
# Standalone-Tool. Aufruf manuell: `pwsh ~/.codex/hooks/blunder-scan.ps1`
...
"@
    ...
    Write-Host "[blunder-scan] HINWEIS: Dieser Hook ist standalone — zur Ausfuehrung aus einer Codex-Code-Session:" -ForegroundColor Yellow
    ...
    # 3. Wenn wir in einer Codex-Session sind: Ergebnis kann der User sehen
    #    Der eigentliche Agent-Call muss vom Haupt-Codex gemacht werden (Hook hat
