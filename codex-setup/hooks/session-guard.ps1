...
$localSettingsPath = Join-Path $env:USERPROFILE ".codex" "settings.local.json"
...
try {
    $projectsDir = Join-Path $env:USERPROFILE ".codex" "projects"
...
# ================================================
# CHECK 5: Workspace Directory — MUST be ~/Codex/
# ================================================

$expectedDir = Join-Path $env:USERPROFILE "proggs"
$cwdCheckFile = Join-Path $env:TEMP "codex-cwd-check.txt"
...
Write-Output "SessionGuard: WORKSPACE_CHECK — Arbeitsverzeichnis MUSS C:\Users\barwa\Codex sein. Falls pwd=/c/Users/barwa: WARNUNG an Benutzer!"
