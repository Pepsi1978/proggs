...
if [ $auth_count -gt 0 ]; then
    msg="MCP-Auth-Check: ${auth_count} Cloud-Connector(s) haben eine abgelaufene Session: ${auth_needed}. Loesung: codex.ai/settings oeffnen und die Verbindung erneuern (Re-Login)."
    echo "$msg"
    echo "⚠ $msg" >&2
fi
