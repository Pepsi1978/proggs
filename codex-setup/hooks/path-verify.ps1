...
#
# ANWENDUNG:
#   pwsh ~/.codex/hooks/path-verify.ps1          # Pruefung
#   pwsh ~/.codex/hooks/path-verify.ps1 -Fix     # Pruefung + Reparatur
...
$null = Test-CommandExists "codex" "Codex CLI" "npm install -g @anthropic-ai/codex"
...
# --- Windows-spezifische Pfade (REFERENZLISTE aus AGENTS.md) ---
$requiredPaths = @(
