...
EXPERIENCE_PATH="$HOME/proggs/.codex/agent-memory/shared/experience-store.jsonl"
TRAJECTORY_PATH="$HOME/proggs/.codex/agent-memory/shared/trajectories.jsonl"
SCORES_PATH="$HOME/.codex/session-scores.jsonl"
...
try:
    ...
    exp_path = os.path.expanduser('~/.codex/agent-memory/shared/experience-store.jsonl')
    traj_path = os.path.expanduser('~/.codex/agent-memory/shared/trajectories.jsonl')
