# hook-log.ps1 — Error logging for Codex hooks (PowerShell 7)
...
#
# Logs to: ~/.codex/logs/hooks/YYYY-MM-DD.log
# Log rotation: files older than 14 days are auto-deleted

$script:_HookLogDir = Join-Path $env:USERPROFILE ".codex" "logs" "hooks"
