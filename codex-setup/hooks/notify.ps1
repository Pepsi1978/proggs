# Dynamic notification for Windows: extracts the actual message from Codex
...
try {
    ...
    [Windows.UI.Notifications.ToastNotificationManager]::CreateToastNotifier('Codex').Show(
