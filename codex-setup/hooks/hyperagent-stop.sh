...
# Event: Stop (fires when Codex finishes a response)
# Type: prompt (injects text into Codex's context)
# Platform: macOS/Linux
#
# PURPOSE: Reminds Codex to perform metacognitive analysis before completing.
...
# An empty output means no prompt injection — Codex continues normally.
