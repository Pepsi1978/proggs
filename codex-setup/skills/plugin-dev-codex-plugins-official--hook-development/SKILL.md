...
# Hook Development for Codex Plugins

## Overview

Hooks are event-driven automation scripts that execute in response to Codex events. Use hooks to validate operations, enforce policies, add context, and integrate external tools into workflows.
...
Execute when Codex session begins. Use to load context and set environment.
...
**Important:** Hooks are loaded when Codex session starts. Changes to hook configuration require restarting Codex.

**Cannot hot-swap hooks:**
- Editing `hooks/hooks.json` won't affect current session
- Adding new hook scripts won't be recognized
- Changing hook commands/prompts won't update
- Must restart Codex: exit and run `codex` again

**To test hook changes:**
1. Edit hook configuration or scripts
2. Exit Codex session
...
Hooks are validated when Codex starts:
...
- **Official Docs**: https://docs.claude.com/en/docs/codex/hooks
...
8. Test in Codex with `codex --debug`
