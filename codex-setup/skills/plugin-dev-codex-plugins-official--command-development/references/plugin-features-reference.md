...
This reference covers features and patterns specific to commands bundled in Codex plugins.

## Table of Contents

- [Plugin Command Discovery](#plugin-command-discovery)
- [CODEX_PLUGIN_ROOT Environment Variable](#codex_plugin_root-environment-variable)
...
Codex automatically discovers commands in plugins using the following locations:
