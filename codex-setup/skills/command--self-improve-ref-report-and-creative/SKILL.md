---
name: command--self-improve-ref-report-and-creative
description: "Converted from command self-improve-ref:report-and-creative"
---
...
2. Line Count: `wc -l ~/.codex/commands/self-improve.md` — warn if > 600 (main file) or total > 2000
...
- **Startup time**: How long until Codex is ready? Are 87+ plugins slowing startup?
