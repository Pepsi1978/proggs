...
A Codex skill that detects timing side-channel vulnerabilities in cryptographic code by analyzing assembly or bytecode output for dangerous instructions.

## What This Skill Does

When activated, this skill helps Codex:
...
The skill activates automatically when Codex detects:
...
You can also invoke it explicitly by asking Codex to check code for timing vulnerabilities.
