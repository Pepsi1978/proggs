...
Codex automatically detects git context:
...
```bash
bash ${CODEX_PLUGIN_ROOT}/skills/resolve-pr-parallel/scripts/get-pr-comments PR_NUMBER
```
...
```bash
bash ${CODEX_PLUGIN_ROOT}/skills/resolve-pr-parallel/scripts/resolve-pr-thread THREAD_ID
```
