---
name: command--tool-check-ref-meta-improve
description: "Converted from command tool-check-ref:meta-improve"
---
...
```
wc -l ~/.codex/commands/tool-check.md
```
...
```bash
cp ~/.codex/commands/tool-check.md ~/Codex/codex-harness/commands/
cp -r ~/.codex/commands/tool-check-ref/ ~/Codex/codex-harness/commands/tool-check-ref/
cd ~/prompts:proggs && git add codex-harness/commands/tool-check.md codex-harness/commands/tool-check-ref/
