...
**Whiteboard-Pfad (Windows):** `C:\Users\barwa\.codex\agent-memory\shared\MEMORY.md`
**Whiteboard-Pfad (macOS/Linux):** `~/.codex/agent-memory/shared/MEMORY.md`
...
4. Der Fix aendert KEINE kritischen Systemdateien ohne klaren Auftrag (settings.json, AGENTS.md, hooks mit globalen Auswirkungen → nur nach Bewertung)
...
- Aendere NIEMALS `~/.codex/AGENTS.md` oder `~/.codex/settings.json` automatisch — zu viel Risiko
