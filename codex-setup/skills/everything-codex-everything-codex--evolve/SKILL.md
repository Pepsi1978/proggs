...
```
/prompts:everything-codex-everything-codex--evolve                    # Analyze all instincts and suggest evolutions
/prompts:everything-codex-everything-codex--evolve --generate         # Also generate files under evolved/{skills,commands,agents}
```
