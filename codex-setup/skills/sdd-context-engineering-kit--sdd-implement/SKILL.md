...
- **Value of `${CODEX_PLUGIN_ROOT}` so agents can resolve paths like `@${CODEX_PLUGIN_ROOT}/scripts/create-scratchpad.sh`**
...
Read @${CODEX_PLUGIN_ROOT}/prompts/judge.md for evaluation methodology.
