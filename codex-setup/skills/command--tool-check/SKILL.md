...
(check for .swift + .cs files, or AGENTS.md cross-platform references), note it:
...
5. **Dokumentieren**: Absturz in `.codex/agent-memory/shared/MEMORY.md` → Abschnitt "Offene Fehler & Probleme" eintragen.
...
| Kotlin | detekt / ktlint | `./prompts:gradlew detekt` or `ktlint "**/*.kt"` |
| Android | Android Lint | `./prompts:gradlew lint` |
