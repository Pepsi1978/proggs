...
description: This skill should be used when the user asks to "add MCP server", "integrate MCP", "configure MCP in plugin", "use .mcp.json", "set up Model Context Protocol", "connect external service", mentions "${CODEX_PLUGIN_ROOT} with MCP", or discusses MCP server types (SSE, stdio, HTTP, WebSocket). Provides comprehensive guidance for integrating Model Context Protocol servers into Codex plugins for external tool and service integration.
version: 0.1.0
---

# MCP Integration for Codex Plugins

## Overview

Model Context Protocol (MCP) enables Codex plugins to integrate with external services and APIs by providing structured tool access. Use MCP integration to expose external service capabilities as tools within Codex.
...
**Process management:**
- Codex spawns and manages the process
- Communicates via stdin/stdout
- Terminates when Codex exits
...
OAuth handled automatically by Codex:
...
- **Codex MCP Docs**: https://docs.claude.com/en/docs/codex/mcp
