...
module FeatureFlags
  ...
  REASONING_MODEL = ENV.fetch("DSPY_REASONING_MODEL", "ruby_llm/codex-sonnet-4-20250514")
end
...
# DSPY_REASONING_MODEL=ruby_llm/codex-sonnet-4-20250514
#
...
# DSPy.configure do |c|
#   c.lm = DSPy::LM.new('openrouter/anthropic/codex-3.5-sonnet',
