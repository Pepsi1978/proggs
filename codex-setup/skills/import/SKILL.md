...
Your job: read `~/Codex/codex-harness/mirror-ledger.md`, find all entries that are
...
`~/Codex/codex-harness/mirror-ledger.md`
...
Examples:
- Codex -> `~/.codex/rules/auto-learned/`
...
Examples:
- Codex -> `AGENTS.md` plus repo copy
...
- update `codex-harness/settings.json`
- update `codex-harness/settings-reference.json`
- validate JSON
