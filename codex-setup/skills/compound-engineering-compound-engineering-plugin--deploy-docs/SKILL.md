...
# Validate JSON
cat .codex-plugin/marketplace.json | jq . > /dev/null && echo "✓ marketplace.json valid"
cat plugins/compound-engineering/.codex-plugin/plugin.json | jq . > /dev/null && echo "✓ plugin.json valid"
