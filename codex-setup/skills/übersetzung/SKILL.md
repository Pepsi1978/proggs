...
```
~/.codex/skills/übersetzung/übersetzung-global.md   (macOS)
$env:USERPROFILE/.codex/skills/übersetzung/übersetzung-global.md   (Windows)
```

**NIEMALS** nach `~/Codex/uebersetzung-global.md` (ohne Umlaut) suchen — dieser Pfad
existiert nicht. Die korrekte Datei heisst mit Umlaut und ist Teil des Skills. Fallback
bei Nicht-Auffinden: `~/Codex/übersetzung-global.md` — das ist die Master-Kopie.
...
```
Glob: ~/Codex/[AppName]*/**/strings.xml
```
...
Die Datei `~/.codex/skills/übersetzung/übersetzung-global.md` lesen (mit Umlaut!).
...
`~/Codex/übersetzung-global.md` (Master-Kopie im Repo).
