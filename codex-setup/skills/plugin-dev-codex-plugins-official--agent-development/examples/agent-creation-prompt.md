...
Use this template to generate agents using Codex with the agent creation system prompt.
...
Send this to Codex (with the agent-creation-system-prompt loaded):
...
Tell Codex when the agent should activate:
...
- **Comprehensive**: Codex includes edge cases and quality checks
