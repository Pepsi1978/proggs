...
This is the exact system prompt used by Codex's agent generation feature, refined through extensive production use.
...
This provides AI-assisted agent generation following proven patterns from Codex's internal implementation.
