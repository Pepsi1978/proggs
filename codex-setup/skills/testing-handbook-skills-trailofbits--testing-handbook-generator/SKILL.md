...
description: >
  ...
  and generates Codex skills for security testing tools and techniques.
  Use when creating new skills based on handbook content.
---

# Testing Handbook Skill Generator

Generate and maintain Codex skills from the Trail of Bits Testing Handbook.
...
| GUI-only tool (e.g., `web/burp/`) | Skip section (Codex cannot operate GUI tools) |
