...
Some handbook sections describe tools that require graphical user interfaces and cannot be operated by Codex. Skip these unconditionally:

| Section | Tool | Reason |
|---------|------|--------|
| `**/web/burp/` | Burp Suite | GUI-based HTTP proxy; requires visual interaction |

These tools are excluded because Codex cannot:
