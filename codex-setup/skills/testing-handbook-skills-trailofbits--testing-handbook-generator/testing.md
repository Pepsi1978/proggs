...
- No reserved words ("anthropic", "codex") in name
...
Verify Codex activates the skill correctly.
...
- Codex references skill content
- Codex follows skill workflow
...
- Codex selects this skill over alternatives
- Codex uses skill content appropriately

### Test 3: Decision Tree Navigation

**Test:** Codex navigates to supporting files correctly
