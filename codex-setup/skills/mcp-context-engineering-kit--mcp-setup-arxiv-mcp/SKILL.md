...
2. After Docker Desktop is installed, guide user to connect MCP using: <https://docs.docker.com/ai/mcp-catalog-and-toolkit/get-started/#codex>
3. Once configured, ask user to restart Codex and run "continue" to resume setup
