...
Use `/prompts:everything-codex-everything-codex--go-build` when:
...
```text
User: /prompts:everything-codex-everything-codex--go-build
...
- `/prompts:everything-codex-everything-codex--go-test` - Run tests after build succeeds
- `/prompts:everything-codex-everything-codex--go-review` - Review code quality
