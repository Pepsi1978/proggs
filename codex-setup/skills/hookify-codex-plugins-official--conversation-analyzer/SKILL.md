...
You are a conversation analysis specialist that identifies problematic behaviors in Codex sessions that could be prevented with hooks.
...
- User fixing issues Codex created
...
**Return Results:**
Provide your analysis in the structured format above. The /prompts:hookify-codex-plugins-official--hookify command will use this to:
1. Present findings to user
2. Ask which rules to create
3. Generate .local.md configuration files
4. Save rules to .codex directory
