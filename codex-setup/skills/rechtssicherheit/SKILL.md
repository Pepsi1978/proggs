...
description: "Use for Android privacy and Play Store compliance checks, text reviews, and knowledge-base updates."
invocation: user
---
...
Pruefe ob `~/Codex/rechtssicherheit.md` existiert.
...
`~/Codex/rechtssicherheit.md` updaten (oder neu anlegen).
...
Danach committen und pushen — `rechtssicherheit.md` gehoert ins Repo (`~/Codex/`).
...
>
> 1. Lade `~/Codex/rechtssicherheit.md` (oder lege sie neu an)...
...
Am Ende IMMER:
1. Bericht ausgeben
2. `~/Codex/rechtssicherheit.md` commit+push
