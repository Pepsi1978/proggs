...
|--------|-----------|-------|
| Codex Action | Yes | Check `with.prompt` and `with.codex_args` for embedded expressions |
...
- `with.codex_args` -- may embed expressions as inline instructions (Codex Action)
