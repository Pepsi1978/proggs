...
5. Codex executes with tainted prompt -- attacker achieves prompt injection
```
...
5. Codex executes with tainted prompt via pull_request_target (has secrets access)
```
