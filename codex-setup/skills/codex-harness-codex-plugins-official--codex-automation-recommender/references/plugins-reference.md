...
|--------|----------|--------------|
| **plugin-dev** | Building Codex plugins | Skills for creating skills, hooks, commands, agents |
...
- User wants to install Codex automations from Anthropic's official repository or another shared marketplace
