...
MCP (Model Context Protocol) servers extend Codex's capabilities by connecting to external tools and services.
...
2. **Global config** (`~/.codex.json`) - Available across all projects
...
**Debugging**: Use `codex --mcp-debug` to identify configuration issues.

## Documentation & Knowledge

### context7
**Best for**: Projects using popular libraries/SDKs where you want Codex to code with up-to-date documentation
...
**Value**: Codex fetches live documentation instead of relying on training data, reducing hallucinated APIs and outdated patterns.
...
**Value**: Codex can interact with your running app, take screenshots, fill forms, and verify UI behavior.
...
**Value**: Codex can query tables, manage auth, and interact with Supabase storage directly.
...
**Value**: Codex can create issues, review PRs, check workflow runs, and manage releases.
...
**Value**: Codex can investigate Sentry issues, find root causes, and suggest fixes.
...
**Value**: Codex remembers project context, decisions, and patterns across conversations.
