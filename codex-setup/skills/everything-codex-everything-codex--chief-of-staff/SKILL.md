...
```bash
codex /prompts:mail                    # Email-only triage
codex /prompts:slack                   # Slack-only triage
codex /prompts:today                   # All channels + calendar + todo
codex /prompts:schedule-reply "Reply to Sarah about the board meeting"
```

## Prerequisites

- [Codex](https://docs.anthropic.com/en/docs/codex)
