...
- `.codex/agent-memory/shared/MEMORY.md` — Project conventions, patterns, known bugs ("Offene Fehler & Probleme"), and proven workflows ("Regeln & Konventionen"). Follow what's documented there.
...
- **NIEMALS mehr als 50 Items in einem Durchgang generieren** — das fuehrt zu Kontext-/prompts:output-ueberlauf und Absturz.
