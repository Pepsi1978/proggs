...
#   - ECC observing other tools' automated sessions (e.g. codex-mem)
...
# Layer 1: CODEX_CODE_ENTRYPOINT — set by Codex itself to indicate how
...
case "${CODEX_CODE_ENTRYPOINT:-cli}" in
  cli) ;;
  *) exit 0 ;;
esac
...
# Layer 3: Cooperative skip env var — tools like codex-mem can set this
