---
name: command--android-dev-references-testing
description: "Converted from command android-dev:references:testing"
---
...
./prompts:gradlew testDemoDebug

# Run instrumented tests
./prompts:gradlew connectedDemoDebugAndroidTest

# Run specific module tests
./prompts:gradlew :feature:topic:impl:testDemoDebug

# Screenshot tests (Roborazzi)
./prompts:gradlew recordRoborazziDemoDebug  # Record baseline
./prompts:gradlew verifyRoborazziDemoDebug  # Verify against baseline
```
