...
Use `/prompts:everything-codex-everything-codex--go-review` when:
...
```text
User: /prompts:everything-codex-everything-codex--go-review
...
- Use `/prompts:everything-codex-everything-codex--go-test` first to ensure tests pass
- Use `/prompts:everything-codex-everything-codex--go-build` if build errors occur
- Use `/prompts:everything-codex-everything-codex--go-review` before committing
- Use `/prompts:everything-codex-everything-codex--code-review` for non-Go specific concerns
