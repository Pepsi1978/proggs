---
name: harness-audit
description: Converted from command harness-audit
---
...
`/prompts:everything-codex-everything-codex--harness-audit [scope] [--format text|json]`
...
3) Add command parity for /prompts:everything-codex-everything-codex--harness-audit in .opencode/commands/
```
