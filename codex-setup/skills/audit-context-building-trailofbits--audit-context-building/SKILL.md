...
This skill governs **how Codex thinks** during the context-building phase of an audit.

When active, Codex will:
...
Before deep analysis, Codex performs a minimal mapping:
...
When performing ultra-granular analysis, Codex MUST structure output following the format defined in [OUTPUT_REQUIREMENTS.md](resources/OUTPUT_REQUIREMENTS.md).
...
- Return summaries that Codex integrates into its global model.
