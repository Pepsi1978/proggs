---
name: command--command--tampermonkey-version
description: Use AUTOMATICALLY whenever ANY Tampermonkey userscript (.user.js) in ~/Codex/Tampermonkey/ is modified. Ensures version numbers are bumped before committing.
---
...
Dieses Skill gilt IMMER wenn eine oder mehrere `.user.js` Dateien in `~/Codex/Tampermonkey/` geaendert werden - egal ob Code, Konfiguration, Styling oder Positionierung.
