...
The [context window](https://platform.claude.com/docs/en/build-with-claude/context-windows) is a public good. Your Skill shares the context window with everything else Codex needs to know, including:
...
<CardGroup cols={2}>
  ...
  <Card title="Use Skills in Codex" icon="terminal" href="/en/docs/codex/skills">
