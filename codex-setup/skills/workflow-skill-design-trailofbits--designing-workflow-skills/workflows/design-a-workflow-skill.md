...
4. **Test the description.** Read it in isolation — this is the only thing Codex uses to decide activation. Would it cause the skill to activate for the right requests and stay silent for wrong ones?
