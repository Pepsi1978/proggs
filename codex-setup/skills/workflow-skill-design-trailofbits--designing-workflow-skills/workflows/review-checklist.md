...
- [ ] **Description includes trigger keywords** — this is the only field Codex uses to decide activation
...
- [ ] **Read the description in isolation** — Codex uses only this field for activation. Does it activate for the right requests?
