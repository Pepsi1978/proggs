...
**Example spawns:**
```
Task general-purpose: "Use the dhh-rails-style skill at ~/.codex/plugins/.../dhh-rails-style. Read SKILL.md and apply it to: [Rails sections of plan]"

Task general-purpose: "Use the frontend-design skill at ~/.codex/plugins/.../frontend-design. Read SKILL.md and apply it to: [UI sections of plan]"
