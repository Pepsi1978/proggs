---
name: ace-curator
description: Selbstverbessernder Regel-Kurator — analysiert Sessions und verbessert automatisch die operativen Regeln in AGENTS.md und ~/.codex/rules/. Basierend auf ACE (Agentic Context Engineering, Stanford/UC Berkeley, arXiv 2510.04618).
---
...
- Franks Begruessung am Anfang der AGENTS.md (alles zwischen `ACE-PROTECTED-ZONE-START: Franks Begruessung` und `ACE-PROTECTED-ZONE-END: Franks Begruessung`)
- Die 3 Direktiven (alles zwischen `ACE-PROTECTED-ZONE-START: Die 3 Direktiven` und `ACE-PROTECTED-ZONE-END: Die 3 Direktiven`)
- Die Regel-Dateien: `~/.codex/rules/superintelligence.md`, `~/.codex/rules/self-observation.md`, `~/.codex/rules/resilient-bugfixing.md`
...
- `~/.codex/rules/superintelligence.md`
- `~/.codex/rules/self-observation.md`
- `~/.codex/rules/resilient-bugfixing.md`
- `~/.codex/rules/bypass-permissions-permanent.md`
- Alles zwischen `ACE-PROTECTED-ZONE-START` und `ACE-PROTECTED-ZONE-END` in AGENTS.md
...
3. **AGENTS.md Evolvable Zone anpassen** (nur wenn die Aenderung systemweit gelten muss)
...
- Datei: [Pfad]
- Aktion: [Neue Regel / Regel erweitern / AGENTS.md-Sektion anpassen]
