...
## Arguments
Optional specific behavior to address
...
```
{
  ...
  "prompt": "You are analyzing a Codex conversation to find behaviors the user wants to prevent.
...
Use the current working directory (where Codex was started) as the base path.
...
**User says**: "/prompts:hookify-codex-plugins-official--hookify Don't use rm -rf without asking me first"
