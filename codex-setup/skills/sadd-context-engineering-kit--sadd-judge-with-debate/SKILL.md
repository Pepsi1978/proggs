...
Read ${CODEX_PLUGIN_ROOT}/tasks/judge.md for evaluation methodology and execute using following criteria.
...
Read ${CODEX_PLUGIN_ROOT}/tasks/judge.md for evaluation methodology principles.
