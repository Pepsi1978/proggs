...
# /prompts:everything-codex-everything-codex--learn-eval - Extract, Evaluate, then Save

Extends `/prompts:everything-codex-everything-codex--learn` with a quality gate, save-location decision, and knowledge-placement awareness before writing any skill file.
