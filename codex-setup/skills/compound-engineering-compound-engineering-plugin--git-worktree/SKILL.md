...
bash ${CODEX_PLUGIN_ROOT}/skills/git-worktree/scripts/worktree-manager.sh create feature-name
...
bash ${CODEX_PLUGIN_ROOT}/skills/git-worktree/scripts/worktree-manager.sh create feature-login

# List all worktrees
bash ${CODEX_PLUGIN_ROOT}/skills/git-worktree/scripts/worktree-manager.sh list

# Switch to a worktree
bash ${CODEX_PLUGIN_ROOT}/skills/git-worktree/scripts/worktree-manager.sh switch feature-login

# Copy .env files to an existing worktree (if they weren't copied)
bash ${CODEX_PLUGIN_ROOT}/skills/git-worktree/scripts/worktree-manager.sh copy-env feature-login

# Clean up completed worktrees
bash ${CODEX_PLUGIN_ROOT}/skills/git-worktree/scripts/worktree-manager.sh cleanup
```
...
```bash
# Codex recognizes you're not on the PR branch
# Offers: "Use worktree for isolated review? (y/n)"

# You respond: yes
# Script runs (copies .env files automatically):
bash ${CODEX_PLUGIN_ROOT}/skills/git-worktree/scripts/worktree-manager.sh create pr-123-feature-name
...
bash ${CODEX_PLUGIN_ROOT}/skills/git-worktree/scripts/worktree-manager.sh create feature-notifications
...
```bash
bash ${CODEX_PLUGIN_ROOT}/skills/git-worktree/scripts/worktree-manager.sh copy-env feature-name
```
