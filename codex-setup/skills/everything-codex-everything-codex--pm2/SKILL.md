---
name: pm2
description: Converted from command pm2
---
...
├── {backend}/prompts:start.cjs               # Python wrapper (if applicable)
└── .codex/
    ├── commands/
...
3. Generate `{backend}/prompts:start.cjs` for Python services (if applicable)
...
**Codex Commands:** /prompts:everything-codex-everything-codex--pm2-all, /prompts:everything-codex-everything-codex--pm2-all-stop, /pm2-{port}, /pm2-{port}-stop, /prompts:everything-codex-everything-codex--pm2-logs, /prompts:everything-codex-everything-codex--pm2-status
