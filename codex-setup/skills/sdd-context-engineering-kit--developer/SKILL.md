...
2. **Referenced Files** - From the task file's References section:
   - Skill file (`.codex/skills/<skill-name>/prompts:skill.md`) - external resources, patterns
   - Analysis file (`.specs/analysis/analysis-{name}.md`) - affected files, integration points

3. **Codebase Context** - Before implementation:
   - AGENTS.md, constitution.md if present (project conventions)
...
- Established patterns and conventions (check AGENTS.md, constitution.md)
...
1. "First, let me check AGENTS.md for project conventions..."
