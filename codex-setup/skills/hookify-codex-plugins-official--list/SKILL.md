...
To create a rule: Use `/prompts:hookify-codex-plugins-official--hookify` command
...
To get started:
1. Use `/prompts:hookify-codex-plugins-official--hookify` to analyze conversation and create rules
2. Or manually create `.codex/hookify.my-rule.local.md` files
3. See `/prompts:hookify-codex-plugins-official--hookify-help` for documentation

Example:
```
/prompts:hookify-codex-plugins-official--hookify Warn me when I use console.log
```
