...
"Erfahrungs-Hinweis" — damit Codex nicht bei Null anfangen muss.
...
**Pfad**: `~/.codex/agent-memory/shared/experience-store.jsonl`
...
**Pfad**: `~/.codex/agent-memory/shared/bug-cases.jsonl`
