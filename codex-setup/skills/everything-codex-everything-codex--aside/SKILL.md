...
```
/prompts:everything-codex-everything-codex--aside <your question>
/prompts:everything-codex-everything-codex--aside what does this function actually return?
/prompts:everything-codex-everything-codex--aside is this pattern thread-safe?
/prompts:everything-codex-everything-codex--aside why are we using X instead of Y here?
/prompts:everything-codex-everything-codex--aside what's the difference between foo() and bar()?
/prompts:everything-codex-everything-codex--aside should we be worried about the N+1 query we just added?
```
...
- What step was in progress at the moment `/prompts:everything-codex-everything-codex--aside` was invoked?
...
**No question provided (`/prompts:everything-codex-everything-codex--aside` with nothing after it):**
Respond:
```
...
If the question implies changing what is being built (e.g., `/prompts:everything-codex-everything-codex--aside actually, let's use Redis instead`), clarify:
```
...
**No active task (nothing in progress when `/prompts:everything-codex-everything-codex--aside` is invoked):**
...
**Multiple `/prompts:everything-codex-everything-codex--aside` questions in a row:**
...
```
User: /prompts:everything-codex-everything-codex--aside what does fetchWithRetry() actually do?
...
```
User: /prompts:everything-codex-everything-codex--aside is the approach we're taking thread-safe?
