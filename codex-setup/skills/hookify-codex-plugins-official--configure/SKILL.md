...
```
No hookify rules configured yet. Use `/prompts:hookify-codex-plugins-official--hookify` to create your first rule.
```
...
- You can also manually edit .codex/hookify.*.local.md files
- To permanently remove a rule, delete its .local.md file
- Use `/prompts:hookify-codex-plugins-official--hookify-list` to see all configured rules

## Edge Cases

**No rules to configure:**
- Show message about using `/prompts:hookify-codex-plugins-official--hookify` to create rules first
