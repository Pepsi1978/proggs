---
name: command--codex-bridge
description: Converted from command codex-bridge
---
...
1. Lies `~/.codex/state/codex-delta-state.json` fuer den letzten geprueften Commit
2. Fuehre aus: `cd ~/prompts:proggs && git log --oneline <last_commit>..HEAD -- codex-setup/ AGENTS.md`
...
- Nach Benutzer-Approval: `codex-delta-state.json` und `codex-harness/state/codex-delta-state.json` aktualisieren
