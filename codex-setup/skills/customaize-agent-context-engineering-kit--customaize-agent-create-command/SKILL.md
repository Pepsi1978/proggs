...
description: Interactive assistant for creating new Codex commands with proper structure, patterns, and MCP tool integration
...
<task>
You are a command creation specialist. Help create new Codex commands by understanding requirements, determining the appropriate pattern, and generating well-structured commands that follow Scopecraft conventions.
</task>

<context>
CRITICAL: Read the command creation guide first: @/docs/codex-commands-guide.md
...
1. **Planning Commands** (Specialized)
   ...
   - Examples: @/.codex/commands/01_brainstorm-feature.md
             @/.codex/commands/02_feature-proposal.md
...
2. **Implementation Commands** (Generic with Modes)
   ...
   - Update task states
   - Example: @/.codex/commands/implement.md
...
4. **Workflow Commands** (Specialized)
   ...
   - Manage dependencies
   - Track progress
   - Example: @/.codex/commands/04_feature-planning.md
...
**Example:**
- `.codex/commands/frontend/component.md` creates `/component` with description "(project:frontend)"
- `~/.codex/commands/component.md` creates `/component` with description "(user)"
...
```bash
# Command definition
echo 'Fix issue #$ARGUMENTS following our coding standards' > .codex/commands/fix-issue.md
...
```bash
# Command definition
echo 'Review PR #$1 with priority $2 and assign to $3' > .codex/commands/review-pr.md
...
description: Create a git commit
model: codex-3-5-haiku-20241022
---
...
**Project Command** (`/.codex/commands/`)
...
3. **Standard References**:
   ...
   Guide: @/docs/codex-commands-guide.md
   </context>
   ```
...
3. **Update Documentation** (if project command)
   - Add to codex-commands-guide.md
...
*Use Read tool to examine: /.codex/commands/review.md*
...
✅ Creating project command: `/.codex/commands/validate-api.md`
...
Similar to: @/.codex/commands/review.md
</context>
