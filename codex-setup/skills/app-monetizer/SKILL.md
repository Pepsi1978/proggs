...
description: >-
  ...
  Beraters und liefert Prompts die man direkt in Codex einfuegen kann.
---
...
Der Parameter ist immer der **Ordnername** der App im Repo (`~/Codex/`).
...
`~/.codex/skills/app-monetizer/monetization-checklist.md`
