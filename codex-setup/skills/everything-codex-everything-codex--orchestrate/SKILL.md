---
name: orchestrate
description: Converted from command orchestrate
---
...
`/prompts:everything-codex-everything-codex--orchestrate [workflow-type] [task-description]`
...
```
/prompts:everything-codex-everything-codex--orchestrate feature "Add user authentication"
```
...
```
/prompts:everything-codex-everything-codex--orchestrate custom "architect,tdd-guide,code-reviewer" "Redesign caching layer"
```
