...
**Note:** Codex auto-discovers AGENTS.md files in parent directories, making monorepo setups work automatically.
...
- **`#` key shortcut**: During a Codex session, press `#` to have Codex auto-incorporate learnings into AGENTS.md
