---
name: nemo
description: Nemo orchestrator for universal knowledge work where Codex plans the task, Nemo tools execute the work, and results are returned in structured form.
---
...
## Architecture: Codex Thinks, Nemo Outputs

```
User Request
    |
Codex (Opus) — THE BRAIN
...
3. **Denkarbeit vorwegnehmen** — was Codex weiss, muss Nemotron nicht herausfinden:
   ```
...
| Tool | Purpose | Codex denkt vorher... |
|------|---------|----------------------|
