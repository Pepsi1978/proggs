...
- 200K token capacity: The total available context window (200,000 tokens) represents the maximum capacity for storing conversation history and generating new output from Codex.
...
The context window is a public good. Your prompt, command, skill shares the context window with everything else Codex needs to know, including:
...
Usefull for writing prompts, including but not limited to: commands, hooks, skills for Codex, or prompts for sub agents or any other LLM interaction.
