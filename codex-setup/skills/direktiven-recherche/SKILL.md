...
Agent-Tool aufrufen:
  ...
  name: "direktiven-recherche"
  model: "opus"
  prompt: [Den vollstaendigen Agenten-Prompt aus ~/.codex/agents/direktiven-recherche.md lesen und als Prompt uebergeben]
```

**WICHTIG:** Der Agent ist ein Custom Agent in `~/.codex/agents/direktiven-recherche.md`.
...
**Ablauf:**
1. Lies `~/.codex/agents/direktiven-recherche.md` komplett ein
...
4. Ergebnis landet in `~/Codex/DIREKTIVEN-RECHERCHE-[DATUM].md`
