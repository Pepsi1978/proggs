...
- **Skill File**: Path to skill document (e.g., `.codex/skills/<skill-name>/prompts:skill.md`)
...
- AGENTS.md, constitution.md, README.md guidelines if present
- Similar features to understand established approaches

Use the Skill File and Analysis File to gather pattern information. Read all AGENTS.md, constitution.md, README.md guidelines and docs that can be relevant to the task. Cross-reference with actual codebase exploration.
