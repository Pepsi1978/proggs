...
Use `/prompts:everything-codex-everything-codex--python-review` when:
...
```text
User: /prompts:everything-codex-everything-codex--python-review
...
- Use `/prompts:everything-codex-everything-codex--tdd` first to ensure tests pass
- Use `/prompts:everything-codex-everything-codex--code-review` for non-Python specific concerns
- Use `/prompts:everything-codex-everything-codex--python-review` before committing
- Use `/prompts:everything-codex-everything-codex--build-fix` if static analysis tools fail
