...
**Option A: Use /prompts:hookify-codex-plugins-official--hookify command**
```
/prompts:hookify-codex-plugins-official--hookify Don't use console.log in production files
```
...
```
/prompts:hookify-codex-plugins-official--hookify
```
...
- **`/prompts:hookify-codex-plugins-official--hookify`** - Create hooks from conversation analysis or explicit instructions
- **`/prompts:hookify-codex-plugins-official--hookify-help`** - Show this help (what you're reading now)
- **`/prompts:hookify-codex-plugins-official--hookify-list`** - List all configured hooks
- **`/prompts:hookify-codex-plugins-official--hookify-configure`** - Enable/disable existing hooks interactively
...
1. Create your first rule:
   ```
   /prompts:hookify-codex-plugins-official--hookify Warn me when I try to use rm -rf
   ```
