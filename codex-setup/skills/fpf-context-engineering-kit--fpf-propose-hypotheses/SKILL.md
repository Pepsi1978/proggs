...
- **Prompt**:
  ```
  Read ${CODEX_PLUGIN_ROOT}/tasks/init-context.md and execute.
...
- **Prompt**:
  ```
  Read ${CODEX_PLUGIN_ROOT}/tasks/generate-hypotheses.md and execute.
...
- **Prompt**:
  ```
  Read ${CODEX_PLUGIN_ROOT}/tasks/add-user-hypothesis.md and execute.
...
- **Prompt**:
  ```
  Read ${CODEX_PLUGIN_ROOT}/tasks/verify-logic.md and execute.
...
- **Prompt**:
  ```
  Read ${CODEX_PLUGIN_ROOT}/tasks/validate-evidence.md and execute.
...
- **Prompt**:
  ```
  Read ${CODEX_PLUGIN_ROOT}/tasks/audit-trust.md and execute.
...
- **Prompt**:
  ```
  Read ${CODEX_PLUGIN_ROOT}/tasks/decide.md and execute.
