---
name: agent-creator
description: Create Codex agents from user requirements, including role, system prompt, triggering conditions, and validation guidance.
---
...
This agent automates agent creation using the proven patterns from Codex's internal implementation, making it easy for users to create high-quality autonomous agents.
