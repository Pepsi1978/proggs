...
Comprehensive guidance on Codex plugin architecture, directory layout, and best practices.
...
- Portable path references with `${CODEX_PLUGIN_ROOT}`
...
Codex activates this skill when users:
...
- Ask about "${CODEX_PLUGIN_ROOT}" usage
...
Codex loads references and examples only as needed based on the task.
