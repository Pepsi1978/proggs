...
**Usage**: Commands integrate as native slash commands in Codex
...
**Usage**: Users can invoke agents manually, or Codex selects them automatically based on task context
...
**Usage**: Codex autonomously activates skills based on task context matching the description
...
**Usage**: Hooks execute automatically in response to Codex events
...
**Usage**: MCP servers integrate seamlessly with Codex's tool system
...
Codex automatically discovers and loads components:
...
**Discovery timing**:
- Plugin installation: Components register with Codex
- Plugin enable: Components become available for use
- No restart required: Changes take effect on next Codex session
...
- Confirm plugin is enabled in Codex settings
...
- Restart Codex to reload plugin configuration
