...
```swift
enum ModelTier {
    case fast      // codex-3-haiku: ~$0.25/1M tokens
    case balanced  // codex-3-sonnet: ~$3/1M tokens
    case powerful  // codex-3-opus: ~$15/1M tokens

    var modelId: String {
        switch self {
        case .fast: return "codex-3-haiku-20240307"
        case .balanced: return "codex-3-sonnet-20240229"
        case .powerful: return "codex-3-opus-20240229"
        }
    }
}
