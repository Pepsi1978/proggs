...
2. **Run Build & Static Analysis**: Execute `./prompts:gradlew build`, `detekt`, `ktlintCheck`
...
Use `/prompts:everything-codex-everything-codex--kotlin-review` when:
...
````text
User: /prompts:everything-codex-everything-codex--kotlin-review
...
- Use `/prompts:everything-codex-everything-codex--kotlin-test` first to ensure tests pass
- Use `/prompts:everything-codex-everything-codex--kotlin-build` if build errors occur
- Use `/prompts:everything-codex-everything-codex--kotlin-review` before committing
- Use `/prompts:everything-codex-everything-codex--code-review` for non-Kotlin-specific concerns
