---
name: command--command--sound-search
description: >
...
ffmpeg -i /tmp/sound_hq.wav -c:a libvorbis -q:a 5 ~/Codex/[Project]/app/src/main/res/raw/[name].ogg 2>/dev/null
# Or copy WAV directly
cp /tmp/sound_hq.wav ~/Codex/[Project]/app/src/main/res/raw/[name].wav
```
