...
Use `/prompts:everything-codex-everything-codex--kotlin-test` when:
...
````text
User: /prompts:everything-codex-everything-codex--kotlin-test I need a function to validate user registration requests
...
```bash
$ ./prompts:gradlew koverHtmlReport
...
./prompts:gradlew koverVerify

# XML report for CI
./prompts:gradlew koverXmlReport

# Open HTML report
open build/reports/kover/html/index.html

# Run specific test class
./prompts:gradlew test --tests "com.example.UserServiceTest"

# Run with verbose output
./prompts:gradlew test --info
```
...
- `/prompts:everything-codex-everything-codex--kotlin-build` - Fix build errors
- `/prompts:everything-codex-everything-codex--kotlin-review` - Review code after implementation
- `/prompts:everything-codex-everything-codex--verify` - Run full verification loop
