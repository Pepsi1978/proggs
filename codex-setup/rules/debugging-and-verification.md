...
> Ergaenzt: ~/.codex/rules/resilient-bugfixing.md (fuer den eigentlichen Fix)
...
Bei technisch praezisen Aussagen MUSS Codex seine eigene Sicherheit bewerten:
...
`~/.codex/agent-memory/shared/bug-cases.jsonl`
...
### Zusammenspiel
- **Resilient Bugfixing** (`~/.codex/rules/resilient-bugfixing.md`): CBR formalisiert den "Verwandte Fehlerquellen suchen"-Schritt
