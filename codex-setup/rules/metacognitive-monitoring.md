...
vom `session-scorer.sh`-Hook am SessionEnd erfasst und in `~/.codex/session-scores.jsonl`
gespeichert.
...
|-----------|---------|------------------|
| **Intent-Treue** | 25% | Hat Codex das urspruengliche Ziel erreicht? |
...
| "Session-Trend zeigen" | Liest `~/.codex/session-scores.jsonl` und zeigt Trend |
