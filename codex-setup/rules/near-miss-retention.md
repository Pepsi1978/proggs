...
|-------|-------|---------------|
| `~/.codex/agent-memory/shared/experience-store.jsonl` | Automatisch nach jeder Session | `"near_miss": true/false` |
| `~/.codex/agent-memory/shared/trajectories.jsonl` | Tool-Sequenzen der Session | `"near_miss": true/false` |
| `~/.codex/agent-memory/shared/bug-cases.jsonl` | Manuell eingetragen | `"near_miss": true/false` |
...
```json
{
  ...
  "files": ["~/.codex/hooks/experience-logger.sh"],
