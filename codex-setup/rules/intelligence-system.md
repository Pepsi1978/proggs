...
>
> Kerndirektiven: siehe ~/.codex/rules/superintelligence.md und
...
|---------|-----------------|
| Operative Regeln in AGENTS.md | ACE-Curator (mit Benutzer-Bestaetigung) |
| `~/.codex/rules/*.md` (ausser gesperrte) | ACE-Curator (mit Benutzer-Bestaetigung) |
| `~/.codex/agents/*.md` | ACE-Curator (mit Benutzer-Bestaetigung) |

### Defense in Depth (4 Schichten)

1. HTML-Kommentar-Marker in AGENTS.md (sichtbare Grenzen)
...
### Ort
`.codex/agent-memory/shared/MEMORY.md` → Sektion "Bewaehrte Loesungsmuster"
