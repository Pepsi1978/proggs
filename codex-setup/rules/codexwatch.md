# CodexWatch: MCP-Integration & Session-Protokolle

> Konsolidiert aus: codexwatch-session-start, codexwatch-session-protocol,
> codexwatch-tools
...
1. **`get_project_health`** aufrufen (codexwatch MCP)
...
Dokumentation: https://github.com/blackwell-systems/codexwatch#readme
