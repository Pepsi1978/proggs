...
- macOS: Bundle IDs verwenden (z.B. `"com.apple.Terminal"`, `"com.anthropic.Geminifordesktop"`)
- Windows: Prozessnamen verwenden, CASE-INSENSITIVE (z.B. `"WindowsTerminal"`, `"Gemini"`)
...
```
# macOS: Bundle IDs
TARGET_BUNDLE_IDS=com.apple.Terminal,com.anthropic.Geminifordesktop

# Windows: Prozessnamen (case-insensitive)
TARGET_PROCESS_NAMES=WindowsTerminal,pwsh,powershell,Gemini
```
