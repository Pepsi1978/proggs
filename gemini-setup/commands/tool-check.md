...
(check for .swift + .cs files, or Gemini.md cross-platform references), note it:
...
5. **Dokumentieren**: Absturz in `.Gemini/agent-memory/shared/MEMORY.md` → Abschnitt "Offene Fehler & Probleme" eintragen.
