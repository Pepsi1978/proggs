...
```
wc -l ~/.Gemini/commands/tool-check.md
```
...
```bash
cp ~/.Gemini/commands/tool-check.md ~/proggs/gemini-setup/commands/
cp -r ~/.Gemini/commands/tool-check-ref/ ~/proggs/gemini-setup/commands/tool-check-ref/
cd ~/proggs && git add gemini-setup/commands/tool-check.md gemini-setup/commands/tool-check-ref/
