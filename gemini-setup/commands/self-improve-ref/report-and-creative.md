...
2. Line Count: `wc -l ~/.Gemini/commands/self-improve.md` — warn if > 600 (main file) or total > 2000
...
- **Startup time**: How long until Gemini CLI is ready? Are 87+ plugins slowing startup?
