...
# Event: Stop (fires when Gemini finishes a response)
# Type: prompt (injects text into Gemini's context)
# Platform: macOS/Linux
#
# PURPOSE: Reminds Gemini to perform metacognitive analysis before completing.
...
# An empty output means no prompt injection — Gemini continues normally.
