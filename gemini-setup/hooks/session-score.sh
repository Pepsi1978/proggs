...
# Writes to ~/.Gemini/session-scores.jsonl for trend analysis
...
SCORE_FILE="$HOME/.Gemini/session-scores.jsonl"
...
# Output for Gemini CLI hook display (stderr, not stdout)
