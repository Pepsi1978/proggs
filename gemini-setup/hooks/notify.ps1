# Dynamic notification for Windows: extracts the actual message from Gemini CLI
...
try {
    ...
    [Windows.UI.Notifications.ToastNotificationManager]::CreateToastNotifier('Gemini CLI').Show(
