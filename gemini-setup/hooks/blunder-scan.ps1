...
# Standalone-Tool. Aufruf manuell: `pwsh ~/.Gemini/hooks/blunder-scan.ps1`
...
"@
    ...
    Write-Host "[blunder-scan] HINWEIS: Dieser Hook ist standalone — zur Ausfuehrung aus einer gemini-setup-Session:" -ForegroundColor Yellow
    ...
    # 3. Wenn wir in einer Gemini-Session sind: Ergebnis kann der User sehen
    #    Der eigentliche Agent-Call muss vom Haupt-Gemini gemacht werden (Hook hat
