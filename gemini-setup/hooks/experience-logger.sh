...
EXPERIENCE_PATH="$HOME/proggs/.Gemini/agent-memory/shared/experience-store.jsonl"
TRAJECTORY_PATH="$HOME/proggs/.Gemini/agent-memory/shared/trajectories.jsonl"
SCORES_PATH="$HOME/.Gemini/session-scores.jsonl"
...
try:
    ...
    exp_path = os.path.expanduser('~/proggs/.Gemini/agent-memory/shared/experience-store.jsonl')
    traj_path = os.path.expanduser('~/proggs/.Gemini/agent-memory/shared/trajectories.jsonl')
