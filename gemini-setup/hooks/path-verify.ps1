...
#
# ANWENDUNG:
#   pwsh ~/.Gemini/hooks/path-verify.ps1          # Pruefung
#   pwsh ~/.Gemini/hooks/path-verify.ps1 -Fix     # Pruefung + Reparatur
...
$null = Test-CommandExists "Gemini" "Gemini CLI CLI" "npm install -g @anthropic-ai/gemini-setup"
...
# --- Windows-spezifische Pfade (REFERENZLISTE aus Gemini.md) ---
$requiredPaths = @(
