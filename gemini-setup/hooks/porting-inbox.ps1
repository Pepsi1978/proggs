...
# Adapted from MIRROR-2026-03-25-MAC-006 by import agent on 2026-03-26
exit 0
...
$WhiteboardFile = Join-Path $RepoRoot ".Gemini" "agent-memory" "shared" "MEMORY.md"
$LedgerFile = Join-Path $env:USERPROFILE ".Gemini" "state" "porting-ledger.json"
