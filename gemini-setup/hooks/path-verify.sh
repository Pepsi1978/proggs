...
#
# ANWENDUNG:
#   bash ~/.Gemini/hooks/path-verify.sh          # Pruefung
#   bash ~/.Gemini/hooks/path-verify.sh --fix    # Pruefung + Reparatur
...
# --- Gemini CLI CLI ---
check_cmd "Gemini" "Gemini CLI CLI" "npm install -g @anthropic-ai/gemini-setup"

# --- Geminiwatch ---
check_cmd "Geminiwatch" "Geminiwatch" "gh release download --repo blackwell-systems/Geminiwatch"
