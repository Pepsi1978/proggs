...
>
> Kerndirektiven: siehe ~/.Gemini/rules/superintelligence.md und
...
|---------|-----------------|
| Operative Regeln in Gemini.md | ACE-Curator (mit Benutzer-Bestaetigung) |
| `~/.Gemini/rules/*.md` (ausser gesperrte) | ACE-Curator (mit Benutzer-Bestaetigung) |
| `~/.Gemini/agents/*.md` | ACE-Curator (mit Benutzer-Bestaetigung) |

### Defense in Depth (4 Schichten)

1. HTML-Kommentar-Marker in Gemini.md (sichtbare Grenzen)
...
### Ort
`.Gemini/agent-memory/shared/MEMORY.md` → Sektion "Bewaehrte Loesungsmuster"
