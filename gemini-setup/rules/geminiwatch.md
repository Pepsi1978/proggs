# GeminiWatch: MCP-Integration & Session-Protokolle

> Konsolidiert aus: Geminiwatch-session-start, Geminiwatch-session-protocol,
> Geminiwatch-tools
...
1. **`get_project_health`** aufrufen (Geminiwatch MCP)
...
Dokumentation: https://github.com/blackwell-systems/Geminiwatch#readme
