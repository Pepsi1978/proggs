...
|-------|-------|---------------|
| `~/proggs/.Gemini/agent-memory/shared/experience-store.jsonl` | Automatisch nach jeder Session | `"near_miss": true/false` |
| `~/proggs/.Gemini/agent-memory/shared/trajectories.jsonl` | Tool-Sequenzen der Session | `"near_miss": true/false` |
| `~/proggs/.Gemini/agent-memory/shared/bug-cases.jsonl` | Manuell eingetragen | `"near_miss": true/false` |
...
```json
{
  ...
  "files": ["~/.Gemini/hooks/experience-logger.sh"],
...
```bash
grep '"near_miss": true' ~/proggs/.Gemini/agent-memory/shared/experience-store.jsonl | \
