...
> Ergaenzt: ~/.Gemini/rules/resilient-bugfixing.md (fuer den eigentlichen Fix)
...
Bei technisch praezisen Aussagen MUSS Gemini seine eigene Sicherheit bewerten:
...
`~/proggs/.Gemini/agent-memory/shared/bug-cases.jsonl`
...
### Zusammenspiel
- **Resilient Bugfixing** (`~/.Gemini/rules/resilient-bugfixing.md`): CBR formalisiert den "Verwandte Fehlerquellen suchen"-Schritt
