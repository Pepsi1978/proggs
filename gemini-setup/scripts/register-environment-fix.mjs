...
function buildEntry(args, existingEntry = null) {
	...
	const entry = {
		...
		what_was_fixed: ensureText(
			args.what || existingEntry?.what_was_fixed,
			"what",
		),
		why_it_was_fixed: ensureText(
			args.why || existingEntry?.why_it_was_fixed,
			"why",
		),
