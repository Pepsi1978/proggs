...
egal ob Gemini CLI, Codex CLI, Gemini CLI, Cursor, Aider oder ein anderes
...
| Projektregeln im Repo (Gemini.md, AGENTS.md, etc.) | Wird bei jedem Repo-Oeffnen geladen | Lokale Config-Aenderungen |
...
Primaerquelle: `gemini-setup/bridges/directive-1-superintelligence-universal.md`
Urspruengliche Implementierung: Gemini CLI, 2026-03-22.
