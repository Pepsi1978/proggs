...
- Gemini CLI schreibt NIEMALS in Codex-Verzeichnisse
...
- "was kann Gemini CLI von Codex lernen"
- "Codex-Delta pruefen"
- "synchronisiere mit Codex"

## State

- `gemini-setup/state/codex-delta-state.json` trackt den letzten geprüften Commit
