...
Agent-Tool aufrufen:
  ...
  name: "direktiven-recherche"
  model: "opus"
  prompt: [Den vollstaendigen Agenten-Prompt aus ~/.Gemini/agents/direktiven-recherche.md lesen und als Prompt uebergeben]
```

**WICHTIG:** Der Agent ist ein Custom Agent in `~/.Gemini/agents/direktiven-recherche.md`.
...
**Ablauf:**
1. Lies `~/.Gemini/agents/direktiven-recherche.md` komplett ein
