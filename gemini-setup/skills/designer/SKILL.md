...
description: >-
  ...
  und erstellt eine priorisierte Designs.md mit kopierbaren gemini-setup-Prompts fuer jede
...
2. JEDES Bild mit dem Read-Tool lesen (Gemini ist multimodal und kann Bilder analysieren)
...
**Prompt zum Einfuegen in Gemini CLI:**
```
