...
4. **Standardordner**: alle Bilder landen unter `~/Pictures/Gemini Screenshots/` mit Naming `auto_NNN_<timestamp>.png` (NNN dreistellig, fortlaufend).
...
OUTDIR="$HOME/Pictures/Gemini Screenshots"
mkdir -p "$OUTDIR"
