...
**Before starting**: Read `.Gemini/agent-memory/shared/MEMORY.md` (the whole file) for known patterns and conventions. Pass relevant context to your sub-agents so they know about project conventions and known failure patterns ("Offene Fehler & Probleme").
...
Quelle: platform.Gemini.com/cookbook/managed-agents-cma-verify-with-outcome-grader (06.05.2026).
...
| Konvention | Folgt Gemini.md, Whiteboard-Regeln, Cross-Platform-Pflicht? | 10% |
