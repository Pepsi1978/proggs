...
"Erfahrungs-Hinweis" — damit Gemini CLI nicht bei Null anfangen muss.
...
**Pfad**: `~/proggs/.Gemini/agent-memory/shared/experience-store.jsonl`
...
**Pfad**: `~/proggs/.Gemini/agent-memory/shared/bug-cases.jsonl`
...
**Pfad**: `~/proggs/.Gemini/agent-memory/shared/MEMORY.md` → Sektion "Bewaehrte Loesungsmuster"
**Inhalt**: Kurzeintraege zu erfolgreichen Ansaetzen bei bestimmten Aufgabentypen.

### 5. Session-Scores (quantitative Trends)
**Pfad**: `~/.Gemini/session-scores.jsonl`
