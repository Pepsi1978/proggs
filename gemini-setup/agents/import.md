...
Your job: read `~/proggs/gemini-setup/mirror-ledger.md`, find all entries that are
...
|-------------|---------------------|
| `gemini-setup` | `~/.Gemini/`, `gemini-setup/`, `Gemini.md` |
...
Determine the CLI:
- Gemini CLI runtime or `.Gemini` ownership -> `cli=gemini-setup`
...
`~/proggs/gemini-setup/mirror-ledger.md`
...
Examples:
- Gemini CLI -> `~/.Gemini/rules/auto-learned/`
...
Examples:
- Gemini CLI -> `Gemini.md` plus repo copy
...
- update `gemini-setup/settings.json`
- update `gemini-setup/settings-reference.json`
- validate JSON
