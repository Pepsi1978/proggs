---
description: "Selbstverbessernder Regel-Kurator — analysiert Sessions und verbessert automatisch die operativen Regeln in Gemini.md und ~/.Gemini/rules/. Basierend auf ACE (Agentic Context Engineering, Stanford/UC Berkeley, arXiv 2510.04618)."
---
...
- Franks Begruessung am Anfang der Gemini.md (alles zwischen `ACE-PROTECTED-ZONE-START: Franks Begruessung` und `ACE-PROTECTED-ZONE-END: Franks Begruessung`)
- Die 3 Direktiven (alles zwischen `ACE-PROTECTED-ZONE-START: Die 3 Direktiven` und `ACE-PROTECTED-ZONE-END: Die 3 Direktiven`)
- Die Regel-Dateien: `~/.Gemini/rules/superintelligence.md`, `~/.Gemini/rules/self-observation.md`, `~/.Gemini/rules/resilient-bugfixing.md`
...
- `~/.Gemini/rules/superintelligence.md`
- `~/.Gemini/rules/self-observation.md`
- `~/.Gemini/rules/resilient-bugfixing.md`
- `~/.Gemini/rules/bypass-permissions-permanent.md`
- Alles zwischen `ACE-PROTECTED-ZONE-START` und `ACE-PROTECTED-ZONE-END` in Gemini.md
...
3. **Gemini.md Evolvable Zone anpassen** (nur wenn die Aenderung systemweit gelten muss)
...
- Datei: [Pfad]
- Aktion: [Neue Regel / Regel erweitern / Gemini.md-Sektion anpassen]
