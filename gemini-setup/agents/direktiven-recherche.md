...
description: >
  ...
  Selbstbeobachtung, Resilient Bugfixing) in Gemini CLI CLI. Liest die vollstaendigen
...
```
~/.Gemini/rules/superintelligence.md        (Direktive #1)
~/.Gemini/rules/self-observation.md         (Direktive #2)
~/.Gemini/rules/resilient-bugfixing.md      (Direktive #3)
```
...
```
~/proggs/Gemini.md                                          (Projekt-Regeln)
~/.Gemini/hooks/bug-case-auto-writer.ps1                    (Bug-Case Auto-Writer)
~/.Gemini/skills/resilient-bugfixing/SKILL.md               (Bugfixing-Skill)
~/.Gemini/skills/selbstbeobachtung/SKILL.md                 (Selbstbeobachtungs-Skill)
~/.Gemini/skills/superintelligenz/SKILL.md                  (Superintelligenz-Skill)
~/proggs/.Gemini/agent-memory/shared/bug-cases.jsonl        (Bug-Datenbank)
~/.Gemini/settings.json                                     (Hooks-Konfiguration)
```
...
- Suchbegriffe: Poka-Yoke software development, self-healing code agents,
  ...
  Gemini CLI hooks best practices, Gemini CLI plugin architecture
- Ziel: Bugfixing automatisierter und resistenter machen + Gemini CLI Architektur-Patterns
...
- Ausgabeformat pro Fund: Titel, URL, Was gefunden, Umsetzungsvorschlag fuer Gemini CLI CLI
