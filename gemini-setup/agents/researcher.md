...
**Before researching**: Read `.Gemini/agent-memory/shared/MEMORY.md` (the whole file), especially "Forschung & Intelligence" — to avoid researching topics already covered in previous runs.
