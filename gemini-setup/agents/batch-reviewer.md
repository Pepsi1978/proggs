...
**Before reviewing**: Read `.Gemini/agent-memory/shared/MEMORY.md` (the whole file) for project conventions, known failure patterns ("Offene Fehler & Probleme"), and proven workflows.
