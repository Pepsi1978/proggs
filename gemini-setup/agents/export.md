...
self-contained entries to `~/proggs/gemini-setup/mirror-ledger.md` so that
other platforms (macOS, Windows) and other CLIs (Gemini CLI, Codex CLI, Gemini CLI)
...
|-------------|-----------------|-------------------------|
| `gemini-setup` | `~/.Gemini/`, `gemini-setup/`, `Gemini.md` | `codex-setup/`, `gemini-setup/`, `GEMINI.md` |
| `codex` | `~/.codex/`, `codex-setup/`, `AGENTS.md` | `gemini-setup/`, `gemini-setup/`, `Gemini.md`, `GEMINI.md` |
| `gemini` | local Gemini config, `gemini-setup/`, `GEMINI.md` | `gemini-setup/`, `codex-setup/`, `Gemini.md`, `AGENTS.md` |

Shared artifacts like `~/proggs/gemini-setup/mirror-ledger.md` may always be read.
...
Determine the CLI:
- active Gemini CLI workspace or `.Gemini` ownership -> `cli=gemini-setup`
...
- `.Gemini/` or `gemini-setup/` -> `gemini-setup`
...
| `directive` | `Gemini.md`, `GEMINI.md`, `AGENTS.md`, equivalent top-level directives |
...
Target rules:
- Prefer exact target keys such as `windows/gemini-setup`, `macos/codex`, `windows/gemini`.
...
It is shared across macOS, Windows, Gemini CLI, Codex CLI, and Gemini CLI via git.
