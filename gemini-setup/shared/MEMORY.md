...
<!-- ARCHIV (2026-05-15, /self-improve Thorough): 35 Spam-Eintraege archiviert: -->
<!--   - 30x startup-checks.ps1 Speicherplatz 95-96% (2026-04-27 bis 2026-05-10) — Disk-Spam — Root Cause: 96% Speicher dauerhaft, Spam-Filter im Hook fehlt -->
<!--   - 1x bash-guard.ps1 rm -rf blockiert (2026-04-27) — erwartetes Verhalten -->
<!--   - 6x session-guard.ps1 effortLevel-Reset (2026-05-07/08/10) — erwartetes Verhalten bei /clear oder Startup -->
<!--   - 3x memory-watchdog.ps1 Write-Back AUTO-LOGGED (2026-05-07) — informativ, agent_id-Guard greift wenn echter Subagent fehlt -->
<!--   - 2x StopFailure API/Rate-Limit (2026-04-23, 2026-05-10) — temporaer -->
<!--   - 3x auto-sync.ps1 Merge-Konflikt (2026-04-23, 2026-05-08, 2026-05-10) — GEFIXT durch Konflikt-Marker-Guard in auto-sync.ps1 2026-05-15 -->
<!--   - 1x startup-checks.ps1 Disk-Spam (2026-05-10 bis 2026-05-15) — GEFIXT durch robusten Cooldown + Cleanup-Skript 2026-05-15 -->
...
**Ursache:** Hook hatte keinen ausreichenden Spam-Filter und litt unter Race-Conditions bei parallelen Session-Starts.
**Betroffene Dateien:** ~/.claude/hooks/startup-checks.ps1, gemini-setup/hooks/startup-checks.ps1, gemini-setup/scripts/disk-cleanup.ps1
**Fix:** (1) Hook-Cooldown robustifiziert: Zeitstempel-Update VOR dem Whiteboard-Eintrag (minimiert Race Condition). (2) `disk-cleanup.ps1` erstellt und 4GB freigegeben. (3) Cooldown-Logik in .sh/.ps1 synchronisiert.
**Status:** GEFIXT (2026-05-15)

### 2026-05-10 — Hook: auto-sync.ps1 — Merge-Konflikt seit 3 Tagen
**Quelle:** Hook auto-sync.ps1 (Windows)
**Symptom:** "git pull --rebase fehlgeschlagen (Merge-Konflikt?)"
**Ursache:** Parallele Sessions schreiben gleichzeitig in MEMORY.md. Bisher keine Erkennung von Konflikt-Markern VOR dem Pull.
**Betroffene Dateien:** gemini-setup/hooks/auto-sync.ps1
**Fix:** (1) Konflikt-Marker-Guard in auto-sync.ps1 implementiert: bricht Pull lautstark ab, wenn `<<<<<<<` in MEMORY.md gefunden wird. (2) Whiteboard-Insert-Mutex bleibt langfristiges Ziel.
**Status:** GEFIXT (2026-05-15)
