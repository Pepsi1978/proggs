...
> `best-practices/projekt-code/chrome-extensions/best-practices.md` (Bezugs-Tabelle unten).
...
**FIX:** siehe oben; fuer Code-Vorlage `best-practices/projekt-code/chrome-extensions/best-practices.md`.
...
| Bug-Abschnitt (hier) | Best-Practice-Abschnitt (`best-practices/projekt-code/chrome-extensions/best-practices.md`) |
|----------------------|---------------------------------------------------------------------------------------------|
