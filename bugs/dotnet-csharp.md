...
## 🔗 Bezug zu den Best Practices ([`best-practices/projekt-code/dotnet-csharp/best-practices.md`](../best-practices/projekt-code/dotnet-csharp/best-practices.md))
...
| Bug-Abschnitt (hier) | Praevention in `best-practices/projekt-code/dotnet-csharp/` |
|----------------------|------------------------------------------------------|
