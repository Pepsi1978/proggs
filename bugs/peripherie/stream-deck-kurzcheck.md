...
| 17 | Nach Explorer-Absturz/-Neustart tot | Heuristik: Stream Deck zuerst verdaechtigen, Fix wie 16. `crashpad_handler` NUR nach Pfad `\Elgato\` zaehlen — fremde Apps haben eigene | §R2, R3 |
...
> **Weiche vor jeder Fehlersuche (§R):** Reagiert das Geraet komplett nicht, erst pruefen ob es
