...
| 16 | ⭐ ChatGPT-OAuth Fast gewählt, Response meldet `service_tier=default` | Nicht mit API-Key-Semantik auswerten: laut OpenAI ist das finale Tier bei OAuth kein verlässlicher Fast-Nachweis. Requestoption `priority` separat prüfen und OAuth-Fast aus Konfiguration/Modellkatalog ableiten. | §10 (#80a) |
