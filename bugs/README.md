...
| **Google-Drive-Backup & Cloud-Sync** (Room-DB + Fotos → appDataFolder) | [`android/google-drive-backup.md`](android/google-drive-backup.md) | 2026-06-14 | ~55 | `*Drive*.kt`/`*Backup*.kt`/`*Restore*.kt`/`*Sync*.kt`, `appDataFolder`, `DriveScopes`, `GoogleAuthUtil`, `google-api-services-drive` · „Google Drive", „appDataFolder", „Backup", „Restore", „Orphan/Waisen", „md5Checksum", „Multi-Device", „drive.appdata", „AuthorizationClient", „storageQuotaExceeded", „resumable upload", „WAL/Room restore" · Best-Practices: `best-practices/projekt-code/android/best-practices-google-drive-backup.md` |
