...
| **R8** (Code-Shrinker/Optimizer/Obfuscator, ProGuard-Nachfolger) | [`android-build/r8.md`](android-build/r8.md) | 2026-06-03 | ~50 | `proguard-rules.pro`, `consumer-rules.pro`, `*.keep.xml` · „R8", „minifyEnabled", „shrinkResources", „keep-Regel", „Full-Mode", „Release-Crash", „Obfuscation", „ProGuard", „missing_rules", „mapping.txt" · Best-Practices: `best-practices/android-build/r8.md` |
