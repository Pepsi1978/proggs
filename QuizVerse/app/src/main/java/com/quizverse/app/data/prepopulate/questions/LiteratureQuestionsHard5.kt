...
fun literatureQuestionsHard5(): List<Question> = listOf(
    ...
    Question(
        ...
        answerA = "Professor Woland",
        answerB = "Doktor Faust",
    ...
    Question(
        ...
        answerB = "Manuskripte brennen nicht",
        answerC = "Liebe überwindet alle Grenzen",
    ...
    Question(
        ...
        answerB = "Sie wird Wolands Gastgeberin beim Hexensabbat",
        answerC = "Sie flieht mit dem Meister nach Jerusalem",
        answerD = "Sie verbrennt Wolands Buch",
        correctAnswer = 1, // B
    ...
    Question(
        ...
        answerA = "Adso von Melk",
        answerB = "Abt Abbon",
        answerC = "Jorge von Burgos",
    ...
    Question(
        ...
        answerA = "Roger Bacon",
        answerB = "William von Baskerville",
        answerC = "Thomas von Aquin",
    ...
    Question(
        ...
        answerB = "Ein Briochestück",
        answerC = "Eine Madeleine",
        answerD = "Ein Macaron",
        correctAnswer = 2, // C
    ...
    Question(
        ...
        answerA = "Verfallene Gutshöfe",
        answerB = "Verstorbene Leibeigene, die noch als lebend geführt werden",
    ...
    Question(
        ...
        answerB = "Pierre Menard, Autor des Quixote",
    ...
    Question(
        ...
        answerC = "Die Bibliothek von Babel",
    ...
    Question(
        ...
        answerD = "Die Kosmischen Geschichten",
        correctAnswer = 2, // C
    ...
    Question(
        ...
        answerA = "Mit dem Ende des Zweiten Weltkriegs",
        answerB = "Mit der Unabhängigkeit Indiens am 15. August 1947",
    ...
    Question(
        ...
        answerC = "Die obsessive Überzeugung, dass nur die Zerstörung des Schönen ihn von seiner Schönheitssucht befreit",
        answerD = "Rache an seinem Abt",
        correctAnswer = 2, // C
    ...
    Question(
        ...
        answerB = "Bayn al-Qasrayn, Qasr al-Shauq und Al-Sukkariyya",
        answerC = "Khan el-Khalili, Muqattam und Zamalek",
    ...
    Question(
        ...
        answerA = "Der schwarze Mönch",
        answerB = "Station Nr. 6",
    ...
    Question(
        ...
        answerA = "Das Aleph",
        answerB = "Die Lotterie in Babylon",
        answerC = "Tlön, Uqbar, Orbis Tertius",
        answerD = "Der Garten der sich verzweigenden Pfade",
        correctAnswer = 2, // C
    ...
    Question(
        ...
        answerC = "In Swanns Welt",
        answerD = "Sodom und Gomorrha",
        correctAnswer = 2, // C
    ...
    Question(
        ...
        answerA = "Der Baron auf den Bäumen",
        answerB = "Der nicht existierende Ritter",
        answerC = "Der geteilte Visconte",
    ...
    Question(
        ...
        answerB = "No Longer at Ease",
        answerC = "A Man of the People",
        answerD = "Anthills of the Savannah",
        correctAnswer = 1, // B
    ...
    Question(
        ...
        answerA = "Das Messer-Prinzip",
        answerB = "Tschechows Kanone",
        answerC = "Tschechows Gewehr",
    ...
    Question(
        ...
        answerB = "Lange, fließende Sätze mit minimaler Interpunktion und ohne Anführungszeichen für Dialoge",
        answerC = "Wechselnde Erzählperspektiven in jedem Kapitel",
