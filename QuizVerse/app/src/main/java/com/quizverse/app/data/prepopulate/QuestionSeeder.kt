...
import com.quizverse.app.data.prepopulate.questions.logicQuestionsEasy5
import com.quizverse.app.data.prepopulate.questions.logicQuestionsMedium5
import com.quizverse.app.data.prepopulate.questions.logicQuestionsHard4
import com.quizverse.app.data.prepopulate.questions.logicQuestionsHard5
import com.quizverse.app.data.prepopulate.questions.logicQuestionsExpert2
import com.quizverse.app.data.prepopulate.questions.logicQuestionsExpert6
import com.quizverse.app.data.prepopulate.questions.logicQuestionsMaster2
import com.quizverse.app.data.prepopulate.questions.logicQuestionsMaster3
import com.quizverse.app.data.prepopulate.questions.logicQuestionsMaster4
import com.quizverse.app.data.prepopulate.questions.logicQuestionsMaster5
...
import com.quizverse.app.data.prepopulate.questions.herthaBscQuestionsMaster3
import com.quizverse.app.data.prepopulate.questions.herthaBscQuestionsMaster4
import com.quizverse.app.data.prepopulate.questions.herthaBscQuestionsMaster5
import com.quizverse.app.data.prepopulate.questions.herthaBscQuestionsMaster6
...
object QuestionSeeder {
    ...
    private suspend fun insertCategories(database: QuizDatabase) {
        ...
        val categories = listOf(
            Category(id = 1,  name = "Weltgeographie",      iconName = "\uD83C\uDF0D", gradientStartColor = 0xFF4FACFEL, gradientEndColor = 0xFF00F2FEL, questionCount = 1542, isLocked = false),
            Category(id = 2,  name = "Wissenschaft & Natur",iconName = "\uD83D\uDD2C", gradientStartColor = 0xFF6C63FFL, gradientEndColor = 0xFFA855F7L, questionCount = 1517, isLocked = false),
            ...
            Category(id = 4,  name = "Film & Fernsehen",    iconName = "\uD83C\uDFAC", gradientStartColor = 0xFFEC4899L, gradientEndColor = 0xFFF43F5EL, questionCount = 1503, isLocked = false),
            Category(id = 5,  name = "Musik",               iconName = "\uD83C\uDFB5", gradientStartColor = 0xFF8B5CF6L, gradientEndColor = 0xFFC084FCL, questionCount = 1500, isLocked = false),
            Category(id = 6,  name = "Sport",               iconName = "\uD83C\uDFC5", gradientStartColor = 0xFF22C55EL, gradientEndColor = 0xFF10B981L, questionCount = 1517, isLocked = false),
            Category(id = 7,  name = "Technologie",         iconName = "\uD83D\uDCBB", gradientStartColor = 0xFF3B82F6L, gradientEndColor = 0xFF6366F1L, questionCount = 1563, isLocked = false),
            Category(id = 8,  name = "Essen & Trinken",     iconName = "\uD83C\uDF73", gradientStartColor = 0xFFF59E0BL, gradientEndColor = 0xFFEF4444L, questionCount = 1507, isLocked = false),
            Category(id = 9,  name = "Tierwelt",            iconName = "\uD83D\uDC3E", gradientStartColor = 0xFF14B8A6L, gradientEndColor = 0xFF06B6D4L, questionCount = 1548, isLocked = false),
            Category(id = 10, name = "Sprache & Literatur", iconName = "\uD83D\uDCDA", gradientStartColor = 0xFF8B5CF6L, gradientEndColor = 0xFFEC4899L, questionCount = 1523, isLocked = false),
            Category(id = 11, name = "Alle Kategorien",      iconName = "\uD83C\uDF1F", gradientStartColor = 0xFFF43F5EL, gradientEndColor = 0xFFF97316L, questionCount = 1549, isLocked = false),
            Category(id = 12, name = "Logik & Denksport",   iconName = "\uD83E\uDDE0", gradientStartColor = 0xFF0EA5E9L, gradientEndColor = 0xFF6366F1L, questionCount = 1577, isLocked = false),
            // ── Bundesliga-Vereine (Unterkategorien von Sport) ──────────
            Category(id = 13, name = "Hertha BSC",          iconName = "\u26BD",       gradientStartColor = 0xFF1A5276L, gradientEndColor = 0xFF2E86C1L, questionCount = 1517, isLocked = false),
            Category(id = 14, name = "Borussia Dortmund",   iconName = "\u26BD",       gradientStartColor = 0xFFFDD835L, gradientEndColor = 0xFF212121L, questionCount = 1532, isLocked = false),
            // ── Neue Kategorien ───────────────────────────────────────
    ...
    private suspend fun insertQuestions(database: QuizDatabase) {
        ...
        val all = geoQuestions() +
            ...
            logicQuestionsExpert2() +
            logicQuestionsExpert3() +
            logicQuestionsExpert4() +
            logicQuestionsExpert5() +
            logicQuestionsExpert6() +
            logicQuestionsMaster1() +
            logicQuestionsMaster2() +
            logicQuestionsMaster3() +
            logicQuestionsMaster4() +
            logicQuestionsMaster5() +
            logicQuestionsMaster6() +
            herthaBscQuestions() +
            ...
            herthaBscQuestionsMaster3() +
            herthaBscQuestionsMaster4() +
            herthaBscQuestionsMaster5() +
            herthaBscQuestionsMaster6() +
            dortmundQuestions() +
