...
object Sicherung {
    ...
    fun baueDateiname(zeitstempel: String): String = "claude-kompass-sicherung-$zeitstempel.json"
    ...
    fun lies(inhalt: String): Pair<SicherungsVorschau, JSONObject> {
        val json = runCatching { JSONObject(inhalt) }.getOrElse {
            throw SicherungsFehler("Die Datei ist keine gültige Sicherung von Claude Kompass.", it)
        }
