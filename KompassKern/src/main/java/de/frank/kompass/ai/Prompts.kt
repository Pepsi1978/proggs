...
object Prompts {
    ...
    private const val GRUNDTON =
        "Du erklärst ${AppProfil.WERKZEUG}, das Kommandozeilen-Werkzeug von ${AppProfil.HERSTELLER}, auf Deutsch.\n\n" +
            ...
            "programmieren, kennt aber ${AppProfil.WERKZEUG} noch nicht gut.\n\n" +
    ...
    fun vertiefeAnweisung(stufe: Int): String = GRUNDTON + "\n\n" +
        ...
        "Befehlen oder Einstellungen, den Zusammenhang mit anderen Teilen von ${AppProfil.WERKZEUG}.\n" +
    ...
    fun frageAnweisung(): String = GRUNDTON + "\n\n" +
        "Du beantwortest eine Frage zu einem bestimmten Teil von ${AppProfil.WERKZEUG}. Regeln:\n" +
    ...
    fun chatAnweisung(): String = GRUNDTON + "\n\n" +
        "Du bist der Gesprächspartner in einer App, die ${AppProfil.WERKZEUG} erklärt. Regeln:\n" +
    ...
    fun ersatzAnweisung(): String = GRUNDTON + "\n\n" +
        "Ein Slash-Befehl oder eine Einstellung ist aus ${AppProfil.WERKZEUG} verschwunden. Du sollst " +
