package de.frank.kompass.ui.screens
...
import de.frank.kompass.tts.StimmProbeText
import de.frank.kompass.tts.TtsCatalog
import de.frank.kompass.tts.VorleseManager
import de.frank.kompass.tts.VorleseStufe
import de.frank.kompass.ui.components.AuswahlPunkt
import de.frank.kompass.ui.components.FehlerStreifen
import de.frank.kompass.ui.components.Klappauswahl
import de.frank.kompass.ui.components.Mehrfachauswahl
import de.frank.kompass.ui.components.HinweisStreifen
import de.frank.kompass.ui.components.Merkzeichen
...
import de.frank.kompass.vm.PruefErgebnis
...
fun EinstellungenScreen(
    ...
    LazyColumn(
        ...
        item {
            Block("Über die App") {
                Zeilentext("Version ${AppProfil.VERSION_NAME} (${AppProfil.VERSION_BUMPED_AT})")
                Zeilentext(
                    "Mitgelieferte Wissensbasis: ${AppProfil.WERKZEUG} ${AppProfil.SEEDED_CLI_VERSION}",
                )
                Spacer(Modifier.height(Mass.abstandKlein))
