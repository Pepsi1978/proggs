    ...
    Column(modifier = modifier) {
        ...
        if (sitzungen.isEmpty()) {
            LeerZustand(
                ...
                text = "Leg eines an und frag alles, was du über ${AppProfil.WERKZEUG} wissen willst. " +
            ...
            Box(modifier = Modifier.weight(1f), contentAlignment = Alignment.Center) {
                LeerZustand(
                    ...
                    text = "Zum Beispiel: Wie halte ich das Gedächtnis in langen Sitzungen " +
                        "sauber? Oder: Welche Einstellung verhindert, dass ${AppProfil.KURZNAME} Zugangsdaten " +
                ...
                if (text.isEmpty()) {
                    Text(
                        text = when (diktiert) {
                            ...
                            else -> "Frag etwas über ${AppProfil.WERKZEUG}"
                        },
                        style = MaterialTheme.typography.bodyMedium,
                        color = farben.textGedaempft,
                    )
