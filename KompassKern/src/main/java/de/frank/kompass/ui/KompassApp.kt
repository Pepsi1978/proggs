...
import de.frank.kompass.ui.components.FehlerStreifen
import de.frank.kompass.ui.components.GoldKnopf
import de.frank.kompass.ui.components.HinweisStreifen
import de.frank.kompass.ui.components.KompassKopfleiste
import de.frank.kompass.ui.components.ThemeKnopf
import de.frank.kompass.ui.components.Trennlinie
import de.frank.kompass.ui.screens.ChatScreen
import de.frank.kompass.ui.screens.EinstellungenScreen
import de.frank.kompass.ui.screens.ReferenzScreen
import de.frank.kompass.ui.screens.SucheScreen
import de.frank.kompass.ui.theme.LocalKompassFarben
import de.frank.kompass.ui.theme.Mass
import de.frank.kompass.ui.theme.ThemeModus
import de.frank.kompass.update.LaufFortschritt
import de.frank.kompass.vm.ChatViewModel
import de.frank.kompass.vm.DiktatViewModel
import de.frank.kompass.vm.EinstellungenViewModel
import de.frank.kompass.vm.ReferenzViewModel
    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                ...
                BerichtsAbschnitt("Entfernt aus ${AppProfil.WERKZEUG}", lauf.entfernteNamen)
...
private fun SperrBildschirm(beiEntsperren: () -> Unit) {
    ...
    Column(
        ...
        Text(
            text = "${AppProfil.PRODUKT} ist gesperrt",
            style = MaterialTheme.typography.titleMedium,
            color = MaterialTheme.colorScheme.onSurface,
        )
        Spacer(Modifier.height(Mass.abstandKlein))
