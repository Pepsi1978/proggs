...
import de.frank.kompass.data.RohEintrag
...
class Aktualisierer(
    ...
    suspend fun fuehreAus(erklaereAlles: Boolean = false, melde: suspend (LaufFortschritt) -> Unit) {
        ...
        try {
            ...
            if (version.isBlank()) throw DokuFehler("Die OpenCode-Versionsnummer konnte nicht gelesen werden. Der Bestand bleibt erhalten.")
