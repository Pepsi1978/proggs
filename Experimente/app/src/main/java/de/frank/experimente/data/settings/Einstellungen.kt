...
class Einstellungen(ctx: Context) {
    ...
    var ausstehend: Set<String>
        ...
        set(v) = p.edit().putStringSet(AUSSTEHEND, v).apply()
    ...
    var verdichtetAm: String
        ...
        set(v) = p.edit().putString(VERDICHTET_AM, v).apply()
    ...
    var hinweisBenachrichtigungGezeigt: Boolean
        ...
        set(v) = p.edit().putBoolean(HINWEIS_BENACHRICHTIGUNG, v).apply()
