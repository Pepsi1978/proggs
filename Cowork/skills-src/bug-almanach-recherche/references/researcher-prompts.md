# Researcher-Prompt-Vorlagen (Cowork)
...
Absturzrisiko; Kappen waere lossy). Bei sehr vielen Funden verlustfrei in eine Datei
schreiben + kompakte Summary/Pfad zurueckgeben, nie abschneiden. Pro Bug zurueckgeben:
...
> und koennen `gh` nicht ausfuehren. (In Cowork: der gh-Schritt muss in EINEM ~45s-Aufruf laufen.)
