...
import de.frank.codexkompass.data.local.AktualisierungEntity
...
import de.frank.codexkompass.data.local.ErklaerungHistorieEntity
import de.frank.codexkompass.data.local.FrageEntity
import de.frank.codexkompass.data.local.KompassDatabase
import de.frank.codexkompass.data.local.SuchTreffer
import de.frank.codexkompass.data.local.SucheFtsEntity
import de.frank.codexkompass.data.local.SuchVerlaufEntity
import de.frank.codexkompass.data.local.baueSuchAnfrage
import de.frank.codexkompass.data.local.normalisiereFuerSuche
