...
import de.frank.codexkompass.data.Sicherung
import de.frank.codexkompass.data.SicherungsFehler
import de.frank.codexkompass.observability.KompassLog
import de.frank.codexkompass.ui.KompassApp
import de.frank.codexkompass.ui.theme.CodexKompassTheme
...
class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CodexKompassTheme(modus = themeModus) {
...
class KompassViewModelFactory(private val container: KompassContainer) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T = when {
        modelClass.isAssignableFrom(de.frank.codexkompass.vm.ReferenzViewModel::class.java) ->
            de.frank.codexkompass.vm.ReferenzViewModel(container) as T
        modelClass.isAssignableFrom(de.frank.codexkompass.vm.ChatViewModel::class.java) ->
            de.frank.codexkompass.vm.ChatViewModel(container) as T
        modelClass.isAssignableFrom(de.frank.codexkompass.vm.EinstellungenViewModel::class.java) ->
            de.frank.codexkompass.vm.EinstellungenViewModel(container) as T
        modelClass.isAssignableFrom(de.frank.codexkompass.vm.DiktatViewModel::class.java) ->
            de.frank.codexkompass.vm.DiktatViewModel(container) as T
