package de.frank.codexkompass.data.local
...
data class EintragEntity(
    ...
    val stufe: Int = 0,
    /** In welcher Codex-CLI-Version der Eintrag dazukam. Leer, solange unbekannt. */
    val seitVersion: String = "",
    val kategorie: String = "",
    /** Gruppe innerhalb des Bereichs, z. B. `Eingebaut` oder `Mitgelieferter Skill`. */
    val art: String = "",
    /** Wurde der Eintrag aus Codex CLI entfernt? Dann steht er im Klapp-Bereich ganz unten. */
...
data class AktualisierungEntity(
    ...
    /** Die Codex-CLI-Version, für die dieser Lauf den Stand gehoben hat. */
