...
object Prompts {
    ...
    private const val GRUNDTON =
        "Du erklärst Codex CLI, das Kommandozeilen-Werkzeug von OpenAI, auf Deutsch.\n\n" +
            ...
            "programmieren, kennt aber Codex CLI noch nicht gut.\n\n" +
    ...
    fun vertiefeAnweisung(stufe: Int): String = GRUNDTON + "\n\n" +
        ...
        "Befehlen oder Einstellungen, den Zusammenhang mit anderen Teilen von Codex CLI.\n" +
    ...
    fun frageAnweisung(): String = GRUNDTON + "\n\n" +
        "Du beantwortest eine Frage zu einem bestimmten Teil von Codex CLI. Regeln:\n" +
    ...
    fun chatAnweisung(): String = GRUNDTON + "\n\n" +
        "Du bist der Gesprächspartner in einer App, die Codex CLI erklärt. Regeln:\n" +
    ...
    fun neuerEintragAnweisung(bereich: String): String = GRUNDTON + "\n\n" +
        ...
        ", der neu zu Codex CLI dazugekommen ist. Du bekommst den Namen und die offizielle " +
    ...
    fun ersatzAnweisung(): String = GRUNDTON + "\n\n" +
        "Ein Slash-Befehl oder eine Einstellung ist aus Codex CLI verschwunden. Du sollst " +
