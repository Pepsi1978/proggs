...
import de.frank.codexkompass.ui.screens.ReferenzScreen
import de.frank.codexkompass.ui.screens.SucheScreen
    ...
    Column(modifier = Modifier.fillMaxSize().background(MaterialTheme.colorScheme.background)) {
        KompassKopfleiste(
            ...
            untertitel = letzterErfolg?.cliVersion?.takeIf { it.isNotBlank() }
                ...
                ?: "Stand: Codex CLI ${BuildConfig.SEEDED_CLI_VERSION}",
            themeModus = themeModus,
    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                ...
                BerichtsAbschnitt("Entfernt aus Codex CLI", lauf.entfernteNamen)
...
private fun SperrBildschirm(beiEntsperren: () -> Unit) {
    ...
    Column(
        ...
        Text(
            text = "Codex Kompass ist gesperrt",
            style = MaterialTheme.typography.titleMedium,
            color = MaterialTheme.colorScheme.onSurface,
        )
        Spacer(Modifier.height(Mass.abstandKlein))
