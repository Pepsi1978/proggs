...
Stand: 14.08.2026 (umbenannt am 10.09.2026: vorher „StackLabor Werft Studio“ im Ordner `StackLaborWerftStudio`)

## 1. Projektgrenze

- Projektordner: `C:\Users\barwa\proggs\StackLabor`
- Gradle-Projektname: `StackLabor`
- Android-Paket und Application-ID: `de.frank.stacklabor.werftstudio` — bleibt bewusst so,
  sonst wäre es für Android eine neue App und die installierten Daten wären nicht mehr erreichbar.
- App-Name: `StackLabor`
...
StackLabor verwaltet Nahrungsergänzungsmittel-Stacks, Ziele und eigene Fragen.
