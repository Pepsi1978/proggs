...
(() => {
  ...
  // UI POSITION
  // ============================================================
  const UI_POS = { leftPx: 16, bottomPx: 124 };
  ...
  function resolveGeminiApiKey() {
    ...
    if (!key || key.includes("PASTE_YOUR_KEY_HERE") || key.toLowerCase().includes("key hier") || key.toLowerCase() === "hier") {
      key = requestApiKey();
    }
    return key;
  }
