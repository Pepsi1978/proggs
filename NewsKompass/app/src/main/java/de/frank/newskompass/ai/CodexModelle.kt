...
/** Was eine Anfrage zurückbringt: der Text, die benutzten Quellen und erzeugte Bilder. */
data class CodexAntwort(
    val text: String,
    val quellen: List<String>,
    val bilderBase64: List<String>,
)
...
data class CodexModell(
    val id: String,
    val name: String,
    val stufen: List<String>,
    val standardStufe: String,
)
