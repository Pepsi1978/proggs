 ...
 */
/** Der Name, unter dem die Sicherung im versteckten appDataFolder liegt. */
internal const val SICHERUNGS_DATEI = "geniale-ideen-sicherung.json"
...
class DriveClient(private val http: OkHttpClient) {
    ...
    suspend fun findBackup(token: String): RemoteFile? = withContext(Dispatchers.IO) {
        val url = "https://www.googleapis.com/drive/v3/files" +
            ...
            "&q=" + encode("name = '${SICHERUNGS_DATEI}' and trashed = false") +
