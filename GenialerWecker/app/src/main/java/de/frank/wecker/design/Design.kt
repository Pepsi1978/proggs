...
fun materialFuer(design: Design, dunkel: Boolean, primaer: Color, gedaempft: Color, text: Color, rahmen: Color): Material = when (design) {
    Design.SCHLICHT -> Material(
        tiefenOben = if (dunkel) 0.06f else 0.03f,
        tiefenUnten = if (dunkel) 0.10f else 0.05f,
        reflexFarbe = Color.White,
        reflexAlpha = if (dunkel) 0.10f else 0.30f,
        reflexWinkelGrad = 40f, reflexLaenge = 0.55f,
        kanteLichtFarbe = primaer,
        kanteLichtAlpha = if (dunkel) 0.35f else 0.45f,
        kanteSchattenAlpha = 0.30f,
        kanteGrund = null,
        innenSchattenAlpha = 0.18f,
        koernungAlpha = 0.04f,
    ...
    Design.MORGENRUHE -> Material(
        tiefenOben = if (dunkel) 0.04f else 0.02f,
        tiefenUnten = if (dunkel) 0.04f else 0.03f,
        reflexFarbe = Color.White,
        reflexAlpha = if (dunkel) 0.06f else 0.18f,
        reflexWinkelGrad = 90f, reflexLaenge = 0.70f,
        kanteLichtFarbe = Color.White,
        kanteLichtAlpha = if (dunkel) 0.10f else 0.40f,
        kanteSchattenAlpha = 0.12f,
        kanteGrund = rahmen,
        innenSchattenAlpha = 0.10f,
        koernungAlpha = 0.05f,
    ...
    Design.TRAUMRAUM -> Material(
        tiefenOben = if (dunkel) 0.05f else 0.03f,
        tiefenUnten = if (dunkel) 0.16f else 0.06f,
        reflexFarbe = if (dunkel) primaer else Color.White,
        reflexAlpha = if (dunkel) 0.08f else 0.20f,
        reflexWinkelGrad = 30f, reflexLaenge = 0.50f,
        kanteLichtFarbe = primaer,
        kanteLichtAlpha = if (dunkel) 0.30f else 0.22f,
        kanteSchattenAlpha = 0.35f,
        kanteGrund = null,
        innenSchattenAlpha = 0.14f,
        koernungAlpha = 0.03f,
        schattenFarbe = primaer,
    ...
    Design.ORBIT -> Material(
        tiefenOben = if (dunkel) 0.03f else 0.02f,
        tiefenUnten = if (dunkel) 0.06f else 0.03f,
        reflexFarbe = Color.White,
        reflexAlpha = if (dunkel) 0.12f else 0.25f,
        ...
        kanteLichtAlpha = if (dunkel) 0.18f else 0.25f,
        kanteSchattenAlpha = 0.20f,
        kanteGrund = rahmen,
        innenSchattenAlpha = 0.22f,
        koernungAlpha = 0f,
        schattenFarbe = null,
