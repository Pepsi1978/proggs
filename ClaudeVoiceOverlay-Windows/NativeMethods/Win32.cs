...
namespace ClaudeVoiceOverlay.NativeMethods
{
    public static class Win32
    {
        ...
        // HWND that the AppWatcher captured.
        [DllImport("user32.dll")]
        ...
        // ── Electron-Fokus & Klick (nur ClaudeVoiceOverlay) ───────────────
        // Diese P/Invokes braucht der AppController, um in das Eingabefeld der
        // Claude-Desktop-/Codex-Electron-App zu fokussieren und zu klicken —
        // der TerminalController kommt ohne sie aus (Terminals brauchen keinen
        // Render-Widget-Fokus). Stammen aus der urspruenglichen Claude-Win32.

        // Findet ein Kind-Fenster (z.B. "Chrome_RenderWidgetHostHWND").
        [DllImport("user32.dll", SetLastError = true)]
        public static extern IntPtr FindWindowEx(IntPtr hwndParent, IntPtr hwndChildAfter, string? lpszClass, string? lpszWindow);

        // Setzt den Tastatur-Fokus auf ein Fenster (nach AttachThreadInput).
        [DllImport("user32.dll")]
        public static extern IntPtr SetFocus(IntPtr hWnd);

        // Maus-Cursor an eine Bildschirmposition setzen (fuer den Klick ins Eingabefeld).
        [DllImport("user32.dll")]
        public static extern bool SetCursorPos(int X, int Y);

        // Synthetischer Mausklick (Down/Up) ueber UIPI hinweg.
        [DllImport("user32.dll")]
