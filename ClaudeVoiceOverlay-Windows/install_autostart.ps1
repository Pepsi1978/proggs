# install_autostart.ps1 — Richtet den Autostart mit Watcher fuer ClaudeVoiceOverlay ein
# Ausfuehren: pwsh -File install_autostart.ps1

$ErrorActionPreference = "Stop"

$exePath = Join-Path $PSScriptRoot "publish\ClaudeVoiceOverlay.exe"
...
$oldLinks = @("ClaudeVoiceOverlay.lnk", "Spracheingabe - Claude Desktop.lnk")
...
Unregister-ScheduledTask -TaskName "Spracheingabe - Claude Desktop" -Confirm:$false -ErrorAction SilentlyContinue
...
Register-ScheduledTask `
    -TaskName "Spracheingabe - Claude Desktop" `
    -Action $action `
    -Trigger $trigger `
    -Settings $settings `
...
Write-Host "Aufgabe: Spracheingabe - Claude Desktop" -ForegroundColor White
