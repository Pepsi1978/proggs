...
namespace ClaudeVoiceOverlay.Services
{
    ...
    public static class RecordingArchive
    {
        ...
        /// <summary>%LOCALAPPDATA%\ClaudeVoiceOverlay\aufnahmen — Ablage der letzten Diktate.</summary>
        ...
        public static string? Archive(string? wavFile, bool success)
        {
            ...
            {
                DiagLog.Write("Recording", "archive_failed",
        ...
        public static IReadOnlyList<string> Recent()
        {
            ...
            {
                DiagLog.Write("Recording", "archive_list_failed",
                    ("err", ex.Message), ("type", ex.GetType().Name));
        ...
        private static void Prune(string dir)
        {
            ...
            {
                DiagLog.Write("Recording", "archive_prune_failed",
                    ("err", ex.Message), ("type", ex.GetType().Name));
            }
        }
    }
