...
namespace ClaudeVoiceOverlay.Services
{
    public sealed class RecordingCuePlayer : IDisposable
    {
        ...
        public RecordingCuePlayer()
        {
            ...
            {
                DiagLog.Write("AudioCue", "preload_failed", ("err", ex.Message), ("type", ex.GetType().Name));
            }
        }
        ...
        private static void Play(SoundPlayer player, string cue)
        {
            ...
            {
                DiagLog.Write("AudioCue", "play_failed", ("cue", cue), ("err", ex.Message), ("type", ex.GetType().Name));
