 ...
 * Prompts are loaded from string-array resources to support localization.
 */
object DailyPromptProvider {
    ...
    private fun buildPromptList(context: Context): List<DailyPrompt> {
        ...
        val categories = listOf(
            PromptCategory.SELF_REFLECTION to res.getStringArray(R.array.prompts_self_reflection),
