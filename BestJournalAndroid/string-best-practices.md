# Android String-Extraktion & String-Erstellung: Best Practices

> **Zweck:** Referenz-Datei fuer einen Skill der (1) alle hardcodierten Strings in einer
> Android-Codebase FINDET und (2) sie als uebersetzungskompatible String-Ressourcen ERSTELLT.
> Die eigentliche Uebersetzung in andere Sprachen ist NICHT Aufgabe dieses Dokuments —
> dafuer existiert der separate Uebersetzungs-Skill (`uebersetzung/SKILL.md`).
>
...
Vor dem Start ein Inventar aller Screens anlegen:

```
Screen-Inventar BestJournal:
...
[ ] EntryDetailScreen.kt      + EntryDetailViewModel.kt
[ ] RecordingOverlay.kt
[ ] ChurnFlowDialog.kt
[ ] ShareEntryDialog.kt
[ ] RetroScreen.kt            + RetroViewModel.kt
```
...
## 10. Platzhalter und Format-Specifier
...
## 11. XLIFF-Tags fuer nicht-uebersetzbare Inhalte
...
## 14. Nicht-uebersetzbare Strings
...
## 16. HTML und Styled Text in Strings
...
## 17. Compose-spezifische Patterns
...
## 18. Dateiorganisation bei grossen Apps
...
## 19. Anti-Patterns — was NIEMALS gemacht werden darf
...
## 20. Automatische Qualitaetspruefung (Lint und CI)
...
## 22. Vollstaendiges Beispiel: Best-Practice strings.xml
