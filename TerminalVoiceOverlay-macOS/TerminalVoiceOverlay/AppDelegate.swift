...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // hintereinander im 150ms-Takt — gut kontrollierbare Geschwindigkeit
        // beim Halten (~6-7 Loeschungen pro Sekunde).
        //
        ...
        panel.onXMouseDown = { [weak self] in
            ...
            self.clearLine()
            // Repeat-Timer: alle 150 ms direkt Ctrl+U senden, OHNE Queue-Umweg.
            ...
            self.xRepeatTimer = Timer.scheduledTimer(withTimeInterval: 0.15, repeats: true) { [weak self] _ in
                guard let self = self else { return }
