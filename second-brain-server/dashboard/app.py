...
VERSION = "0.54.3 (06.07.2026, 18:41 Uhr)"  # 0.54.3: Qdrant-Limit-Empfehlungen sind jetzt reine Richtwerte unter den Feldern. Der Empfehlungsbutton berechnet und zeigt Werte, schreibt sie aber NICHT mehr in die Eingabefelder; gespeichert werden nur manuell eingetragene Feldwerte. Alt: 0.54.2.
