...
VERSION = "0.46.5 (05.07.2026, 23:53 Uhr)"  # 0.46.5: Sichtbarer Server-Bump fuer agent 0.55.0 + brain-api 1.22.1 — semantische Suche und Entity-Abruf haben kein 5/8/50er Ergebnislimit mehr (0 = alle) und grosse Trefferlisten laufen ueber Arbeitscache-Verdichtung. Alt: 0.46.4 Kategorie-Gesamtfragen sequenziell per /category-item.
