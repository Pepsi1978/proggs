...
VERSION = "0.48.0 (06.07.2026, 11:55 Uhr)"  # 0.48.0: Übersicht-Sortierung in der Einträge-gesamt-Blase. Standard bleibt Menge absteigend, aber die Kategorie-Legende liest sich jetzt spaltenweise von oben nach unten; zusätzlicher Alphabet-Schalter sortiert dieselbe Ansicht A-Z. Alt: 0.47.0.
