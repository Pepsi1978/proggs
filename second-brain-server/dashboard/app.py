...
VERSION = "0.56.1 (07.07.2026, 14:27 Uhr)"  # 0.56.1: Dashboard-Übersicht startet bei der Kategorie-Sortierung jetzt standardmäßig mit Alphabet statt Menge (Frank-Wunsch 2026-07-07). DOM-Initialzustand, aria-pressed und overviewSortMode sind konsistent auf alpha gesetzt; Menge bleibt per Klick verfügbar. Alt: 0.56.0 (07.07.2026, 13:09 Uhr).
