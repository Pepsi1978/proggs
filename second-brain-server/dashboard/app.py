...
VERSION = "0.55.0 (06.07.2026, 18:54 Uhr)"  # 0.55.0: Dashboard-Kontext-Prompts wie Android-K. Einstellungen -> Modus-Prompts hat jetzt den Reiter Kontext-Prompts mit Diktat, Speichern, Aktiv-Häkchen, Gemini-Verbessern, Original-zurück und Löschen; /api/config und /api/improve leiten die zentrale Liste und den Zusatzauftrag an den Agenten weiter. Alt: 0.54.3.
