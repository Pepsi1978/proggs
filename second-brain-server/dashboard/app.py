...
VERSION = "0.65.1 (09.07.2026, 13:32 Uhr)"  # 0.65.1: Sichtbarer Bump zum agent-0.67.1-Fix: Hintergrund-Spiegelung fertiger Gespräche erbt den aktiven Turn-Trace nicht mehr, damit Performance-Spans vollständig und turn-genau bleiben. Alt: 0.65.0.
