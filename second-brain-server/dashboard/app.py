...
VERSION = "0.51.0 (06.07.2026, 15:26 Uhr)"  # 0.51.0: Sichtbarer Cortex-Server-Bump für Runtime-Limits in den Einstellungen. Android kann Qdrant-/Agent-Limits speichern; agent 0.56.1 persistiert Agent-Limits und reicht Brain-Limits weiter, brain-api 1.18.0 speichert Qdrant-Overfetch/BM25/Chunking persistent. Dashboard wird mitgebaut, damit der Footer den kombinierten Deploy sichtbar macht. Alt: 0.50.0.
