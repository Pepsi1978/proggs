...
VERSION = "0.46.6 (06.07.2026, 00:09 Uhr)"  # 0.46.6: Timestamp-Korrektur fuer den nach Mitternacht abgeschlossenen Deploy. Sichtbarer Server-Bump fuer agent 0.55.1 + brain-api 1.22.2; Verhalten wie 0.46.5: semantische Suche und Entity-Abruf haben kein 5/8/50er Ergebnislimit mehr (0 = alle) und grosse Trefferlisten laufen ueber Arbeitscache-Verdichtung.
