...
VERSION = "0.46.1 (05.07.2026, 16:43 Uhr)"  # Fix: Reload direkt auf #librarian startet den Bibliothekar-Tab erst nach kompletter Script-Initialisierung, damit gelernte Regeln und Aufgaben-Schalter sichtbar bleiben.
