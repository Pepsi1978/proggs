...
VERSION = "0.47.0 (06.07.2026, 11:45 Uhr)"  # 0.47.0: Bibliothekar-Aufgaben-Editor fuer Standard- und eigene Nacht-Aufgaben. Bearbeiten oeffnet den kompletten aktuellen Prompt, der Bibliothekar diskutiert Verbesserungen mit Verlauf, und Speichern legt Standard-Task-Overrides bzw. aktualisierte eigene Aufgaben ab. Alt: 0.46.6.
