...
VERSION = "0.54.0 (06.07.2026, 17:55 Uhr)"  # 0.54.0: Gesprächs-Modi im Dashboard mit Android synchronisiert. Im Gespräch gibt es jetzt A/S/M/XL sowie Suchen/Speichern/Auto; Modus- und Antwortlängen-Prompts sind unter Einstellungen zwischen System-Prompt und Logbuch zentral bearbeitbar und werden mit Android über agent /config synchronisiert. System-Info-Einträge unter "Was Cortex kann" können jetzt persistent bearbeitet oder gelöscht werden. Alt: 0.53.0.
