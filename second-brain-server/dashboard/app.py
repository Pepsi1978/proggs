...
async def api_put_config(request: Request) -> dict:
    ...
    payload = {k: body.get(k) for k in (
        ...
        "haupt_reasoning", "speicher_reasoning", "abfrage_reasoning", "tavily_enabled"
