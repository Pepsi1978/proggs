...
VERSION = "0.50.0 (06.07.2026, 14:58 Uhr)"  # 0.50.0: Sichtbarer Cortex-Server-Bump fuer agent 0.56.2. Fix: Verschachtelte Anfragen mit "erst Gedächtnis, dann Internet" werden nicht mehr auf eine Einzelroute reduziert; der Agent führt Gedächtnis-Suche und Websuche sequenziell aus und kombiniert die Antwort. Alt: 0.48.0.
