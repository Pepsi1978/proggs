...
VERSION = "0.25.0"  # 0.25.0: Drawer-Buttons (Kategorie, Loeschen, Bearbeiten) zwischen Datum/Zeit und Strich verschoben (Frank-Wunsch 2026-06-27) — lagen vorher unten unter dem Eintragstext; jetzt direkt unter dem Titel/Datum im drawer-head, vor dem Trennstrich. 0.24.9: Logbuch-Drawer: Papierkorb loescht Logbuch-Datei ueber Agent + Cortex-Eintrag per Titel.
