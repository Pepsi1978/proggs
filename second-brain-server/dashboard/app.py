...
VERSION = "0.46.3 (05.07.2026, 23:07 Uhr)"  # 0.46.3: Cortex-Wissen-Speichern gehaertet — jeder gespeicherte Systeminfo-Eintrag bekommt jetzt den Titelpraefix "Cortex Wissen:" und einen Such-Introtext, damit Fragen wie "Was kann Cortex alles schon?" semantisch sicher die Kategorie Cortex treffen. Alt: 0.46.2 (05.07.2026, 22:36 Uhr) Button "Cortex Wissen speichern" + /api/store-Proxy.
