...
VERSION = "0.56.0 (07.07.2026, 13:09 Uhr)"  # 0.56.0: Cortex-Server-Bump für agent 0.60.0 — NEU Turn-Logbuch + Sonden-Trace (Frank-Auftrag 2026-07-07). Jede Anfrage wird nachvollziehbar protokolliert: Frage, Weg (Router->final Intent), Rohtreffer/Auswahl, Confidence, Antwort-Vorschau UND Zeit pro Phase (Router/Suche/Leseagent/Web+Antwort) als Flaschenhals-Radar; 100 Anfragen rollierend, persistent auf der Samba-Platte, secret-frei, best-effort (gefährdet den Chat nie). Problemfälle werden markiert, wenn Frank sinngemäß "das lief schlecht/warum ging das nicht" sagt. Grundlage der Star-Trek-Diagnose (Leseagent wählte 0 von 50 Treffern). Alt: 0.55.3 (06.07.2026, 19:16 Uhr).
