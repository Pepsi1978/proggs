...
VERSION = "0.46.2 (05.07.2026, 22:36 Uhr)"  # 0.46.2: Einstellungen -> System-Info bekommt den Button "Cortex Wissen speichern". Er speichert jeden Eintrag aus dashboard/features.json einzeln als 1:1-Cortex-Wissen in Kategorie Cortex (Titel = sichtbare Ueberschrift, Text = sichtbarer Detailtext), mit Backend-Proxy /api/store damit der Browser keinen SB_API_KEY kennt. Alt: 0.46.1 (05.07.2026, 16:43 Uhr) Fix: Reload direkt auf #librarian startet den Bibliothekar-Tab erst nach kompletter Script-Initialisierung, damit gelernte Regeln und Aufgaben-Schalter sichtbar bleiben.
...
_LIB_ALLOWED = ("status", "run-now", "reports", "report", "process", "process-status",
                "settings", "custom-tasks", "learn", "health",
