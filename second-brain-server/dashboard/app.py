...
VERSION = "0.52.0 (06.07.2026, 15:37 Uhr)"  # 0.52.0: Qdrant-/Quadrant-Limits sind jetzt auch in der Server-Webseite unter Einstellungen sichtbar und speicherbar. dashboard/static/index.html zeigt die Limit-Karte direkt vor System-Prompt; /api/config reicht limits beim PUT an den Agenten durch. Alt: 0.51.1.
