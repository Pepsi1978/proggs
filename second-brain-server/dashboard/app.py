...
VERSION = "0.55.3 (06.07.2026, 19:16 Uhr)"  # 0.55.3: Kontext-Prompt-Blasen werden nach dem Anzeigen des Einstellungen-/Kontext-Reiters erneut gemessen. Dadurch wachsen bereits gespeicherte lange Prompts zuverlässig auf volle Höhe, auch wenn sie beim Laden zuerst in einem versteckten Panel gerendert wurden. Alt: 0.55.2.
