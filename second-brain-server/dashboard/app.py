...
VERSION = "0.51.1 (06.07.2026, 15:33 Uhr)"  # 0.51.1: Sichtbarer Korrektur-Bump für Runtime-Limits: die aktive Brain-API-Version ist 1.23.0 (nicht die frühere historische 1.18.0-Zeile). Android kann Qdrant-/Agent-Limits speichern; agent 0.56.1 persistiert Agent-Limits und reicht Brain-Limits weiter, brain-api 1.23.0 speichert Qdrant-Overfetch/BM25/Chunking persistent. Alt: 0.51.0.
