...
VERSION = "0.25.1"  # 0.25.1: Uebersicht 'Eintraege gesamt' zaehlt Gespraeche und bugfixes/* nicht mehr mit; Kategorien bleiben sichtbar. 0.25.0: Drawer-Buttons im Drawer-Header.
