...
def tavily_search(query: str, response_size: str = "m") -> dict:
    ...
    max_results = {"s": min(TAVILY_MAX_RESULTS, 3), "m": TAVILY_MAX_RESULTS, "xl": max(TAVILY_MAX_RESULTS, 8)}[rs]
