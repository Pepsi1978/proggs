...
VERSION = "0.32.0"  # 0.32.0 (Frank-Auftrag 2026-07-08, 21.55 Uhr): Selbst-Regeln des Hauptagenten — der Agent kann sich dauerhafte Verhaltensregeln geben (Z:\\Logbuch\\Regeln\\regeln.json, extern/Samba), die in JEDEM Gespraech im System-Prompt wirken. Neu: agent/rules.py (atomare Ablage, Regelblock, Trigger-Erkennung), Tools lies_regeln/schreibe_regel, rule_confirm-Chatdialog (Ja/Nein/Bearbeiten), deterministische Regel-vs-Speichern-Unterscheidung (is_rule_request, spec K3a) + Tool-/Prompt-Abgrenzung, REST /rules (GET/POST/PUT/DELETE), Dashboard-Chronik. 40-Regeln-Limit + 6000-Zeichen-Cap gegen Context-Rot. 0.31.1: Wirksamer Counter-Bump: gespeicherte Gespraech-Eintraege erhalten sekundengenauen Zeitstempel.
