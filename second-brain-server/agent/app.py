...
class ChatReq(BaseModel):
    text: str = Field(..., min_length=1, max_length=100000, description="Franks Textnachricht (auch lange Eintraege/Almanache — brain-api chunkt sie selbst; frueher 8000 -> schnitt lange Eintraege ab)")
