...
enum Dialogs {
    ...
    private static var sheetBackground: NSColor {
        ThemeManager.current == .dark ? NSColor.wpf("#12101C") : ThemeManager.palette.desktopBgMid
    }
    ...
    static func showErrorDetails(parent: NSWindow?, details: String) {
        ...
        textView.backgroundColor = ThemeManager.current == .dark ? NSColor.wpf("#1F1C2C") : NSColor.wpf("#FDFDFF")
        textView.textColor = ThemeManager.current == .dark ? NSColor.wpf("#F3F1FB") : NSColor.wpf("#1B1729")
