...
| `werte-lesen.ps1` | Zeigt je Profil SR/RR/FG-Override und die „Override Reserved Keys“ der NVIDIA App (ohne Admin). Fehlen die Keys, ignoriert Treiber 616.92 den Override vermutlich (Almanach B9). Dann in der NVIDIA App unter Grafik → Globale Einstellungen „DLSS Override – Model Presets“ auf „Recommended“ stellen, das wirkt für alle freigegebenen Titel. |
