#!/bin/bash
# Version 1.4.0 - 21.09.2026, 11:37 Uhr
#
...
# Es gibt BEWUSST keinen Schalter, der die Rueckfrage ueberspringt: das Update ist immer an den
# Klick auf "Ja" gebunden (Vorgabe des Benutzers, 21.09.2026).
