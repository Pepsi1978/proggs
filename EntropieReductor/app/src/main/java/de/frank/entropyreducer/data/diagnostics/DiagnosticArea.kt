 ...
 *
 * Jeder Bereich entspricht einem API-Schluessel, Token oder einer Anbindung die fehlschlagen
 * kann ohne dass Frank es im UI sofort sieht. Der [displayName] erscheint im Diagnose-Screen
 * und in der Export-Datei.
 */
enum class DiagnosticArea(val displayName: String) {
    ...
    companion object {
        ...
        fun fromNameOrNull(raw: String?): DiagnosticArea? =
