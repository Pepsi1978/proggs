...
- **Commit ist nicht gleich Rückgabe:** Nach abgebrochener suspendierender DB-Operation kann die Transaktion schon committet sein. Zugehörige Dateien bei unklarem Ausgang erhalten statt anhand eines lokalen Erfolgsflags löschen. Alle konkurrierenden Metadaten-/Editor-Schreiber müssen denselben atomaren Feldänderungsvertrag verwenden. *(lokale Runden 4/7/8 Gedankenspeicher; Almanach §2.10/2.12)*
