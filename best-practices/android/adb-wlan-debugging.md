...
- **Android Studio:** Settings → Build, Execution, Deployment → Debugger → „ADB server lifecycle management“ → „Use existing manually managed server“, sonst startet Studio den Server neu. (https://issuetracker.google.com/issues/256232162)
