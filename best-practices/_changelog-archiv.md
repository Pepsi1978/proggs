...
> Heruntergeladen: 2026-05-25 — WORTWOERTLICH, ungekuerzt (kein WebFetch, keine Zusammenfassung).
> Datum je Version: Publish-Zeitstempel der npm-Registry (@anthropic-ai/claude-code) = faktisches Release-Datum, Format YYYY-MM-DD. Sehr alte 0.2.x ohne npm-Eintrag: "Datum unbekannt".
> Abdeckung: komplette offizielle Versionshistorie, neueste oben, zurueck bis 0.2.21.
> Vorgabe ">= 2.0" ist damit vollstaendig abgedeckt; die aeltere Historie bleibt als Bonus
> fuer die Mustererkennung (wie entwickelt sich Claude Code?) erhalten.
> Aktualisierung: Bei jedem Lauf wird diese Datei neu vom kanonischen CHANGELOG.md geholt
> (verbatim) — neue Versionen kommen oben dazu. NIEMALS zusammenfassen oder kuerzen.
...
## 0.2.82 — Datum unbekannt

- Added support for --disallowedTools
- Renamed tools for consistency: LSTool -> LS, View -> Read, etc.

## 0.2.75 — Datum unbekannt
...
## 0.2.26 — Datum unbekannt

- New /approved-tools command for managing tool permissions
- Word-level diff display for improved code readability
- Fuzzy matching for slash commands

## 0.2.21 — Datum unbekannt
