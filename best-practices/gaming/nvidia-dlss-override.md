...
- Sektion „5 - Common“: `DLSS - Enable DLL Override` = „On - DLSS overridden by latest installed/available“, `DLSS - Forced Preset Letter` = **K** (Quality/Balanced) bzw. M (Performance) / L (Ultra Performance), `DLSS - Forced Model Preset Profile` = Recommended → Apply. `extern` https://www.xda-developers.com/how-to-get-dlss-45-working-in-any-unsupported-title/
