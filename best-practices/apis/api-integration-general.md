# API-Integration anbieterübergreifend — Best Practices (Stand 2026-06-08)
...
- **Zeilenpuffer** (Events splitten über TCP-Pakete), `data:`-Präfix + Doppel-Newline als Event-Grenze, `[DONE]` abfangen, Mid-Stream-`error`-Event behandeln.
