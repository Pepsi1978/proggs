...
> **Zweite Seite der Medaille zum Bug-Almanach** ([`bugs/firebase-billing.md`](../../../bugs/firebase-billing.md)):
...
| Best-Practice-Abschnitt (diese Datei) | Bug-Almanach-Abschnitt (`bugs/firebase-billing.md`) |
|---------------------------------------|------------------------------------------------------|
