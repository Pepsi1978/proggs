...
> **Die "richtige Seite der Medaille" zum Bug-Almanach `~/proggs/bugs/swift-appkit.md`.**
...
Best-Practices (diese Datei) ↔ Bug-Almanach `~/proggs/bugs/swift-appkit.md`. Die identische Tabelle steht
auch dort — so bleibt jede „so macht man es richtig"-Regel mit ihrer konkreten Bug-Loesung verlinkt.

| Best-Practice-Abschnitt (hier) | Zugehoeriger Bug-Almanach-Abschnitt (`bugs/swift-appkit.md`) |
|--------------------------------|-------------------------------------------------------------|
...
- [ ] Bei jedem neu erlebten Bug → Eintrag in `bugs/swift-appkit.md` + ggf. Best-Practice hier ergaenzen, Bezugstabelle synchron halten.
