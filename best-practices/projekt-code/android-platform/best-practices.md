...
> **Zweite Seite der Medaille zum Bug-Almanach** ([`bugs/android-platform.md`](../../../bugs/android-platform.md)):
...
## 🔗 Bezug zum Bug-Almanach ([`bugs/android-platform.md`](../../../bugs/android-platform.md))
...
| Best-Practice (hier) | Verhindert Bug(s) in `bugs/android-platform.md` |
|----------------------|--------------------------------------------------|
