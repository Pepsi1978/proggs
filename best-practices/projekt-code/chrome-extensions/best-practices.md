...
> Die **zweite Seite der Medaille** zum Bug-Almanach [`bugs/chrome-extensions.md`](../../../bugs/chrome-extensions.md):
...
[`bugs/chrome-extensions.md`](../../../bugs/chrome-extensions.md) (Sektionen A–P, 73 Eintraege).
