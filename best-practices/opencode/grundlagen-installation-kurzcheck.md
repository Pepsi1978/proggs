...
| 12 | ChatGPT-OAuth Fast/Priority | Fast-Alias = Basismodell plus `serviceTier:"priority"`. Bei OAuth das finale `service_tier=default` nicht als Standard-Beweis verwenden; Requestoption und Auth-Art getrennt prüfen, als `Fast (OAuth-Routing)` anzeigen. | §3.2 |
