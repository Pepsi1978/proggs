...
Alle Funktionen gehören zur ersten Fassung. Es gibt kein „später".
...
- **Auslöser:** B-08, Abschnitt „Erscheinung".
- **Ablauf:** Drei Möglichkeiten: **Hell** · **Dunkel** · **Wie das System**.
  Vorbelegung: **Dunkel**.
- **Daten:** Geschrieben: Theme-Wert in den verschlüsselten Einstellungen.
- **Ergebnis:** Die Erscheinung wechselt sofort, ohne Neustart.
- **Fehlerfall:** Keiner.
- **Regeln/Grenzen:** Beide Erscheinungen sind gleichrangig und vollständig gebaut.
