...
AREAS = {
    ...
    "opencode/opencode-cli":        ("OpenCode CLI",          ["opencode maus", "opencode-maus", "opencode copy", "opencode-copy", "opencode paste", "opencode-paste", "opencode zwischenablage", "opencode-zwischenablage", "opencode rechtsklick", "opencode-rechtsklick", "opencode tui", "opencode-tui", "tui.json", "copy on select", "copy-on-select"]),
