...
AREAS = {
    ...
    "agents/multi-agent-interop":   ("Multi-Agent-Interop", ["mcp server", "mcp-server", "model context protocol", "model-context-protocol", "a2a", "agent2agent", "agent-to-agent", "agent to agent", "agentenprotokoll", "agenten-protokoll", "acp", "agent client protocol", "agent communication protocol", "handoff", "handoffs", "cross-vendor", "cross vendor", "modelluebergreifend", "modellübergreifend", "agent-uebergabe", "agent übergabe", "git worktree", "git-worktree", "worktree isolation", "agenten-schwarm", "agenten schwarm", "agent swarm", "agent-swarm", "ledger-datei", "ledger datei", "task ledger", "task-ledger", "claude agent sdk", "claude-agent-sdk", "tool poisoning", "tool-poisoning"]),
    ...
    "apis/strava-api":              ("Strava API",           ["strava", "athlete/activities", "strava sync", "strava-sync", "application status inactive", "trainings werden nicht synchronisiert", "polar trainings", "polar-trainings"]),
    "apis/google-gemini-api":       ("Google Gemini API",    ["gemini api", "gemini-api", "generativelanguage", "google-genai", "google genai", "gemini transcribe", "gemini-transcribe", "transcribe-live", "transcribe live", "live api", "live-api", "bidigeneratecontent", "inputaudiotranscription", "interiminputtranscription", "activitystart", "activityend", "automaticactivitydetection", "silencedurationms", "customvocabulary", "custom vocabulary", "speechconfig", "interactions api", "interactions-api", "sprache zu text", "sprache-zu-text", "speech to text", "speech-to-text", "transkription", "transkribieren", "diktat", "thinkingconfig", "gemini embedding", "gemini-embedding"]),
    "gaming/dlss5-mod-inoffiziell":  ("DLSS 5 Mod inoffiziell", ["dlss 5 mod", "dlss-5-mod", "dlss5 mod", "dlss5-mod", "dlssnr", "nvngx_dlssnr", "dlss5 feeder", "dlss5-feeder", "dlss5 swapper", "dlss5-swapper", "optiscaler dlssnr", "optiscaler-dlssnr", "renodx", "neural rendering", "neural-rendering", "deep fried chicken", "deep-fried-chicken", "reshade"]),
    "gaming/nvidia-dlss-override":  ("NVIDIA DLSS Override", ["dlss", "dlss override", "dlss-override", "profile inspector", "profile-inspector", "nvidia profile inspector", "nvngx", "nvngx_dlss", "dlss swapper", "dlss-swapper", "dlsstweaks", "optiscaler", "smooth motion", "smooth-motion", "frame generation", "frame-generation", "multi frame generation", "dlss 5", "dlss5", "dlss-5", "ricochet"]),
    "android/emulator-foldable":    ("Emulator/Foldable",    ["android emulator", "android-emulator", "emulator starten", "avd", "avd anlegen", "virtuelles geraet", "virtuelles gerät", "foldable", "faltbar", "fold 8", "fold8", "z fold", "aufgeklappt", "zugeklappt", "cover display", "cover-display", "hinge", "scharnier", "posture", "emulator skin", "emulator-skin", "geraeteskin", "scrcpy", "geraet spiegeln", "gerät spiegeln", "device mirroring", "live edit", "compose hot reload", "layout inspector", "originalgroesse emulator", "originalgröße emulator", "system-image", "system image", "sdkmanager", "avdmanager"]),
    "android/adb-wlan-debugging":   ("adb über WLAN",        ["adb wlan", "adb-wlan", "adb über wlan", "adb ueber wlan", "wlan debugging", "wlan-debugging", "debugging über wlan", "debugging ueber wlan", "wireless debugging", "wireless-debugging", "adb wifi", "adb-wifi", "adb tcpip", "adb connect", "adb pair", "adb mdns", "wlan installation", "wlan-installation", "adb_wifi_enabled", "per wlan installieren"]),
}
