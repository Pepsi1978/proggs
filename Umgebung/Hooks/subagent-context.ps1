...
Code-Suche laeuft ueber Grep/Glob (semantische Suche/code-search ist im CLI abgeschafft). Exakter Name/String/Regex -> Grep; Dateimuster -> Glob.
- Grep breit zuerst (output_mode count/files_with_matches), dann gezielt content nur fuer relevante Treffer
- Bei erfolglosen Greps das Muster VERBREITERN (Wortstamm, case-insensitive); Datei >500 Zeilen NICHT per Agent editieren
