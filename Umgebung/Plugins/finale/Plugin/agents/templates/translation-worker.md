...
**Token-Disziplin (zwingend):**
- KEIN komplettes Lesen der strings.xml-Dateien (1100 Strings = 50-80 KB jeweils)
- Pre-Check via `grep -c 'name="{key}"' file` statt Read
