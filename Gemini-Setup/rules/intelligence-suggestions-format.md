...
```
­ƒÆí **Intelligenz-Vorschlag N**: [Titel ÔÇö kurz und klar]

**Was ist passiert:** [In einfachen Worten beschreiben was aufgefallen ist]
**Warum ist das ein Problem:** [Erklaeren welche Auswirkung das hat ÔÇö Zeit, Fehler, Risiko]
...
## Beispiel ÔÇö FALSCH (zu kurz, zu technisch)

```
­ƒÆí **Intelligenz-Vorschlag 1**: Race Condition bei Service-Start ÔåÆ Service-Registry implementieren ÔÇö Soll ich das umsetzen?
```

## Beispiel ÔÇö RICHTIG (verstaendlich, begruendet)

```
­ƒÆí **Intelligenz-Vorschlag 1**: Zwei Programme starten gleichzeitig den gleichen Dienst
