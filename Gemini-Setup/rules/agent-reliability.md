...
[Agent 1 laeuft... Ergebnis erhalten ]
[Agent 2 laeuft... FEHLER: Agent hat nach 5 Minuten kein Ergebnis geliefert]
 "Agent 2 (code-reviewer) hat nicht reagiert. Ich starte ihn neu mit kleinerem Scope."
[Agent 2 (Neuversuch)... Ergebnis erhalten ]
[Agent 3 laeuft... Ergebnis erhalten ]
 "Alle 3 Agents haben jetzt Ergebnisse geliefert."
```

## Was NIEMALS passieren darf
- ﯔ Agent laeuft und der Benutzer sieht nichts  keine Updates, keine Fehlermeldung
- ﯔ Agent schlaegt fehl und Claude macht einfach weiter ohne es zu erwaehnen
- ﯔ Benutzer wartet mehr als 15 Minuten auf einen einzelnen Agenten
- ﯔ Agent-Fehler wird in einer technischen Meldung versteckt die der Benutzer nicht versteht
