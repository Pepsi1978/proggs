...
# Self-Improve für Gemini CLI V1.0.0
...
- Nutze Selbstbeobachtung (Direktive 2) als Motor für strukturelle Upgrades.
...
## Prozess-Übersicht
Liefere zu Beginn immer diese Übersicht auf DEUTSCH:

```text
╔══════════════════════════════════════════════════════════════╗
║  Self-Improve Skill — Gemini CLI                            ║
║  Exklusive Umgebungshärtung & Intelligenzsteigerung         ║
╠══════════════════════════════════════════════════════════════╣
║  Stufe 0: GATE — Whiteboard, Direktiven, Grenzen            ║
║  Stufe 0.5: DELTA — Cross-CLI Audits (Codex/Claude)         ║
║  Stufe 1: SCAN — Gemini-Setup & Runtime Prüfung             ║
║  Stufe 2: DEEP-DIVE — Agenten-Analysen & Research           ║
║  Stufe 3: IMPROVE — Fixes, Automatisierung, Ledger          ║
║  Stufe 4: CREATIVE — Neue Ideen & Intelligenz-Hebel         ║
║  Stufe 5: SUPER INTELLIGENZ — Exponentielles Wachstum       ║
║  Stufe 6: DAUERHAFTIGKEIT — Resilienz-Check                 ║
╚══════════════════════════════════════════════════════════════╝
```
...
## Stufe 1: Scan
- Prüfe alle Skripte in `Gemini-Setup/scripts/`.
...
- Nutze `challenger`, `durability-auditor` und `intelligence-researcher` für tiefe Analysen.
- Identifiziere die Top-3 Schwachstellen der aktuellen Umgebung.

## Stufe 3: Improve
- Implementiere die freigegebenen Fixes und Verbesserungen.
- Nutze `writeback-enforcer.sh` für Whiteboard-Updates.
- Registriere Fixes über `register-environment-fix.mjs`.

## Stufe 4: Creative
- Erstelle mindestens ein neues Artefakt (Skript, Regel, Skill-Update).
- Präsentiere 3 neue Intelligenz-Hebel als 💡 Vorschläge.

## Stufe 5: Super Intelligence
- Beweise den Compound Effect: Wie macht diese Änderung künftige Fixes einfacher?
- Fokus auf Meta-Intelligenz (Dimension 8).

## Stufe 6: Dauerhaftigkeit
- Führe die Fix-Induced-Failure Prüfung durch.
- Stelle sicher, dass Dokumentation und Regeln für beide Plattformen (macOS/Windows) valide sind.
