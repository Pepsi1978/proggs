...
NICHT bei: Fragen beantworten, Recherche, reine Dokumentation, Erkl├ñrungen.
...
Code geschrieben
    Ôåô
[1] PRUEFEN ÔÇö Funktioniert es?
    Ôåô
[2] VERIFIZIEREN ÔÇö Sieht es gut aus? Erfuellt es die Anforderungen?
    Ôåô
[3] BEWERTEN ÔÇö Ist es zufriedenstellend?
    Ôåô Nein
[4] VERBESSERN ÔÇö Probleme beheben
    Ôåô
    ÔåÆ Zurueck zu [1]
    Ôåô Ja
[5] ABSCHLIESSEN ÔÇö Erst jetzt "fertig" melden
```
...
- UI/Design: Sieht es professionell und konsistent aus?
  - Farben, Abst├ñnde, Schriftgroessen einheitlich?
...
- [ ] Anforderung 1 erfuellt? ÔåÆ Beweis zeigen
- [ ] Anforderung 2 erfuellt? ÔåÆ Beweis zeigen
- [ ] Anforderung N erfuellt? ÔåÆ Beweis zeigen

Wenn ALLE erfuellt ÔåÆ weiter zu Schritt 5.
Wenn EINE nicht erfuellt ÔåÆ weiter zu Schritt 4.

## Schritt 4: VERBESSERN (Iteration)

- Konkretes Problem identifizieren (nicht raten)
- Gezielt beheben
- NICHT mehrere Probleme gleichzeitig fixen ÔÇö eins nach dem anderen
