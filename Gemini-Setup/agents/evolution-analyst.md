...
1. **Session Scores**: `C:\Users\barwa\GeminiCLI\proggs\Gemini-Setup\session-scores.jsonl`
...
2. **Shared Knowledge Hub**: `C:\Users\barwa\GeminiCLI\proggs\Gemini-Setup\agent-memory/shared/MEMORY.md`
...
4. **README.md**: `C:\Users\barwa\GeminiCLI\proggs\Gemini-Setup\README.md`
   - Current rules and configuration
   - Check if rules are being followed (compare with session data)

5. **Learning Loop State**: `C:\Users\barwa\GeminiCLI\proggs\Gemini-Setup\learning-loop-state.json`
...
6. **Auto-Learned Rules**: `C:\Users\barwa\GeminiCLI\proggs\Gemini-Setup\rules/auto-learned/`
...
3. **Read the agent's prompt**: Open `C:\Users\barwa\GeminiCLI\proggs\Gemini-Setup\agents/[agent-name].md`
...
- New agents go to `C:\Users\barwa\GeminiCLI\proggs\Gemini-Setup\agents/` as proposals, user approves
